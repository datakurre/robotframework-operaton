...
var require_types = __commonJS({
  "node_modules/css-what/lib/commonjs/types.js"(exports2) {
    ...
    (function (AttributeAction3) {
      ...
      (AttributeAction2 =
        exports2.AttributeAction || (exports2.AttributeAction = {})),
    );
  },
});
  ...
  "node_modules/cssom/lib/CSSSupportsRule.js"(exports2) {
    ...
    Object.defineProperty(CSSOM.CSSSupportsRule.prototype, "cssText", {
      get: function () {
        ...
        return (
          "@supports " + this.conditionText + " {" + cssTexts.join("") + "}"
        );
      },
    });
  ...
  "node_modules/bpmn-js/dist/bpmn-viewer.production.min.js"(exports2, module2) {
    !(function (e, t) {
      ...
      function l(e2) {
        ...
        return (
          "[object Function]" === n2 ||
          "[object AsyncFunction]" === n2 ||
          "[object GeneratorFunction]" === n2 ||
          "[object AsyncGeneratorFunction]" === n2 ||
          "[object Proxy]" === n2
        );
      }
      function p(e2) {
      ...
      function f(e2, t2) {
        ...
        const a2 = o(e2) ? w : x;
        for (let i2 in e2)
          if (c(e2, i2) && ((n2 = e2[i2]), (r2 = t2(n2, a2(i2))), false === r2))
            return n2;
      }
      function m(e2, t2, n2) {
        return (
      ...
      function A(e2, t2) {
        var n2 = this;
        ((t2 = t2 || _),
          e2.on(["render.shape", "render.connection"], t2, function (e3, t3) {
            var i2 = e3.type,
              r2 = t3.element,
              o2 = t3.gfx,
              a2 = t3.attrs;
            if (n2.canRender(r2))
              return "render.shape" === i2
                ? n2.drawShape(o2, r2, a2)
                : n2.drawConnection(o2, r2, a2);
          }),
          e2.on(
            ...
            function (e3, t3) {
              if (n2.canRender(t3))
                return "render.getShapePath" === e3.type
                  ? n2.getShapePath(t3)
                  : n2.getConnectionPath(t3);
            },
          ));
      }
      function R(e2, t2) {
      ...
      function M(e2, t2) {
        return (
          !R(e2, "bpmn:CallActivity") &&
          (R(e2, "bpmn:SubProcess")
            ? !(!(t2 = t2 || C(e2)) || !R(t2, "bpmndi:BPMNPlane")) ||
              (t2 && !!t2.isExpanded)
            : !R(e2, "bpmn:Participant") || !!k(e2).processRef)
        );
      }
      function P(e2) {
      ...
      var T = { width: 90, height: 20 },
        N = 15;
      function D(e2) {
        var t2 = e2.length / 2 - 1,
          n2 = e2[Math.floor(t2)],
          i2 = e2[Math.ceil(t2 + 0.01)],
          r2 = (function (e3) {
            var t3 = e3.length / 2 - 1,
              n3 = e3[Math.floor(t3)],
              i3 = e3[Math.ceil(t3 + 0.01)];
            return { x: n3.x + (i3.x - n3.x) / 2, y: n3.y + (i3.y - n3.y) / 2 };
          })(e2),
          o2 = Math.atan((i2.y - n2.y) / (i2.x - n2.x)),
          a2 = r2.x,
          s2 = r2.y;
        return (
          Math.abs(o2) < Math.PI / 2 ? (s2 -= N) : (a2 += N),
          { x: a2, y: s2 }
        );
      }
      function B(e2, t2) {
        ...
        return (
          o2 && o2.bounds
            ? ((r2 = o2.bounds),
              (i2 = { width: Math.max(T.width, r2.width), height: r2.height }),
              (n2 = { x: r2.x + r2.width / 2, y: r2.y + r2.height / 2 }))
            : ((n2 = (function (e3) {
                return e3.waypoints
                  ? D(e3.waypoints)
                  : R(e3, "bpmn:Group")
                    ? { x: e3.x + e3.width / 2, y: e3.y + T.height / 2 }
                    : {
                        x: e3.x + e3.width / 2,
                        y: e3.y + e3.height + T.height / 2,
                      };
              })(t2)),
              (i2 = T)),
          E({ x: n2.x - i2.width / 2, y: n2.y - i2.height / 2 }, i2)
        );
      }
      function L(e2) {
        var t2 = e2.businessObject,
          n2 = (function (e3) {
            return R(e3, "bpmn:FlowElement") ||
              R(e3, "bpmn:Participant") ||
              R(e3, "bpmn:Lane") ||
              R(e3, "bpmn:SequenceFlow") ||
              R(e3, "bpmn:MessageFlow") ||
              R(e3, "bpmn:DataInput") ||
              R(e3, "bpmn:DataOutput")
              ? "name"
              : R(e3, "bpmn:TextAnnotation")
                ? "text"
                : R(e3, "bpmn:Group")
                  ? "categoryValueRef"
                  : void 0;
      ...
      function I(e2, t2) {
        return (
          (function (e3, t3) {
            t3.appendChild(
              (function (e4, t4) {
                if (e4.ownerDocument !== t4.ownerDocument)
                  try {
      ...
      function V(e2, t2, n2) {
        var i2 = t2.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(),
          r2 = F[i2];
        r2
          ? (r2 === j && "number" == typeof n2 && (n2 = String(n2) + "px"),
            (e2.style[i2] = n2))
          : e2.setAttributeNS(null, t2, n2);
      }
      function W(e2, t2, n2) {
        if ("string" == typeof t2) {
          if (void 0 === n2)
      ...
      ((G.prototype.add = function (e2) {
        ...
        (G.prototype.remove = function (e2) {
          return "[object RegExp]" == $.call(e2)
            ? this.removeMatching(e2)
            : (this.list.remove(e2), this);
        }),
        (G.prototype.removeMatching = function (e2) {
          const t2 = this.array();
          for (let n2 = 0; n2 < t2.length; n2++)
            e2.test(t2[n2]) && this.remove(t2[n2]);
          return this;
        }),
        (G.prototype.toggle = function (e2, t2) {
          return (
            void 0 !== t2
              ? t2 !== this.list.toggle(e2, t2) && this.list.toggle(e2)
              : this.list.toggle(e2),
            this
          );
        }),
      ...
      var H = { svg: "http://www.w3.org/2000/svg" },
        K = '<svg xmlns="' + H.svg + '"';
      function U(e2) {
        var t2 = false;
        "<svg" === e2.substring(0, 4)
          ? -1 === e2.indexOf(H.svg) && (e2 = K + e2.substring(4))
          : ((e2 = K + ">" + e2 + "</svg>"), (t2 = true));
        var n2 = (function (e3) {
          var t3;
          return (
            ((t3 = new DOMParser()).async = false),
            t3.parseFromString(e3, "text/xml")
          );
        })(e2);
        if (!t2) return n2;
        for (
          var i2 = document.createDocumentFragment(), r2 = n2.firstChild;
          r2.firstChild;

        )
          i2.appendChild(r2.firstChild);
        return i2;
      }
      function q(e2, t2) {
        var n2;
        return (
          "<" === (e2 = e2.trim()).charAt(0)
            ? ((n2 = U(e2).firstChild), (n2 = document.importNode(n2, true)))
            : (n2 = document.createElementNS(H.svg, e2)),
          t2 && W(n2, t2),
          n2
        );
      }
      ...
      function ie(e2, t2) {
        ...
        switch (e2.nodeType) {
          case 3:
            ...
            break;
          case 1:
            if ((t2.push("<", e2.tagName), e2.hasAttributes()))
              for (n2 = 0, i2 = (r2 = e2.attributes).length; n2 < i2; ++n2)
                ((o2 = r2.item(n2)),
                  t2.push(" ", o2.name, '="', ne(o2.value, ee), '"'));
            if (e2.hasChildNodes()) {
              for (
                t2.push(">"), n2 = 0, i2 = (a2 = e2.childNodes).length;
                n2 < i2;
                ++n2
              )
                ie(a2.item(n2), t2);
      ...
      function re(e2, t2) {
        return (function (e3) {
          for (var t3 = e3.firstChild, n2 = []; t3; )
            (ie(t3, n2), (t3 = t3.nextSibling));
          return n2.join("");
        })(e2);
      }
      function oe(e2) {
      ...
      function ae(e2, t2) {
        return t2 instanceof SVGMatrix
          ? e2.createSVGTransformFromMatrix(t2)
          : t2;
      }
      function se(e2, t2) {
        ...
        return (
          t2 &&
            ...
            (function (e3, t3) {
              var n3, i2;
              for (e3.clear(), n3 = 0; (i2 = t3[n3]); n3++)
                e3.appendItem(ae(e3, i2));
            })(n2, t2)),
          n2.consolidate()
        );
      }
      ...
      function ce(e2, t2) {
        ...
        for (let r3 = 1; r3 < n2; r3++) {
          ...
          const c2 = Math.min(
            t2,
            he(l2.x - n3.x, l2.y - n3.y),
            he(p2.x - l2.x, p2.y - l2.y),
          );
          if (!c2) {
            i2.push(pe2(l2));
            continue;
          }
          const u2 = ue(l2, n3, c2),
            h2 = ue(l2, n3, 0.5 * c2),
            f2 = ue(l2, p2, c2),
            m2 = ue(l2, p2, 0.5 * c2);
          (i2.push(pe2(u2)),
            i2.push(
              ((a2 = m2),
              (s2 = f2),
              ["C", (o2 = h2).x, o2.y, a2.x, a2.y, s2.x, s2.y]),
            ));
        }
        return i2;
      }
      ...
      function me(e2, t2) {
        return (
          W(e2, { d: le(ce(t2, parseInt(e2.dataset.cornerRadius, 10) || 0)) }),
          e2
        );
      }
      var de = "hsl(225, 10%, 15%)",
        ye = "white";
      function ge(e2, t2) {
      ...
      function Ce(e2, t2) {
        ...
        for (let o2 in e2)
          if (
            ke(e2, o2) &&
            ((n2 = e2[o2]), (i2 = t2(n2, r2(o2))), false === i2)
          )
            return n2;
      }
      function Me(e2) {
      ...
      ((De.prototype.add = function (e2) {
        ...
        (De.prototype.remove = function (e2) {
          return "[object RegExp]" == Te.call(e2)
            ? this.removeMatching(e2)
            : (this.list.remove(e2), this);
        }),
        ...
        (De.prototype.has = De.prototype.contains =
          function (e2) {
            return this.list.contains(e2);
          }));
      var Le,
        ...
        Fe = {};
      function Ve() {
        ((Le = window.addEventListener ? "addEventListener" : "attachEvent"),
          (Ie = window.removeEventListener
            ? "removeEventListener"
            : "detachEvent"),
          (je = "addEventListener" !== Le ? "on" : ""));
      }
      var We = Ae(
          {
            __proto__: null,
            bind: (Fe.bind = function (e2, t2, n2, i2) {
      ...
      var ze,
        Ge = {
          bind: function (e2, t2, n2, i2, r2) {
            return (
              -1 !== $e.indexOf(n2) && (r2 = true),
              We.bind(
                e2,
                n2,
                function (n3) {
                  ...
                  ((n3.delegateTarget = (function (e3, t3, n4) {
                    ...
                    return (
                      (i3 &&
                        "function" == typeof i3.closest &&
                        i3.closest(t3)) ||
                      null
                    );
                  })(r3, t2, true)),
                    n3.delegateTarget && i2.call(e2, n3));
                },
                r2,
              )
            );
          ...
          unbind: function (e2, t2, n2, i2) {
            return (
              -1 !== $e.indexOf(t2) && (i2 = true),
              We.unbind(e2, t2, n2, i2)
            );
          },
        },
        He = function (e2, t2) {
          ...
          if ("body" == i2) {
            return (
              ((r2 = t2.createElement("html")).innerHTML = e2),
              r2.removeChild(r2.lastChild)
            );
          }
          var r2,
            o2 = Object.prototype.hasOwnProperty.call(Ue, i2)
              ? Ue[i2]
              : Ue._default,
            a2 = o2[0],
            s2 = o2[1],
          ...
          if (r2.firstChild == r2.lastChild)
            return r2.removeChild(r2.firstChild);
      ...
      "undefined" != typeof document &&
        (((ze = document.createElement("div")).innerHTML =
          '  <link/><table></table><a href="/a">a</a><input type="checkbox"/>'),
        (Ke = !ze.getElementsByTagName("link").length),
        (ze = void 0));
      var Ue = {
        legend: [1, "<fieldset>", "</fieldset>"],
        tr: [2, "<table><tbody>", "</tbody></table>"],
        col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"],
        _default: Ke ? [1, "X<div>", "</div>"] : [0, "", ""],
      };
      ((Ue.td = Ue.th = [3, "<table><tbody><tr>", "</tr></tbody></table>"]),
      ...
      var Qe = (function (e2, t2) {
        ...
        var t2 = (e2.exports = function (e3, n2) {
          if ((n2 || (n2 = 16), void 0 === e3 && (e3 = 128), e3 <= 0))
            return "0";
          for (
            var i2 = Math.log(Math.pow(2, e3)) / Math.log(n2), r2 = 2;
            i2 === 1 / 0;
            r2 *= 2
          )
            i2 = (Math.log(Math.pow(2, e3 / r2)) / Math.log(n2)) * r2;
          var o2 = i2 - Math.floor(i2),
            a2 = "";
      ...
      function et(e2) {
        ...
        ((e2 = e2 || [128, 36, 1]),
          (this._seed = e2.length ? Qe.rack(e2[0], e2[1], e2[2]) : e2));
      }
      ...
      function it(e2, t2, n2, i2, r2, o2, s2) {
        A.call(this, t2, s2);
        var l2 = e2 && e2.defaultFillColor,
          p2 = e2 && e2.defaultStrokeColor,
          c2 = e2 && e2.defaultLabelColor;
        function u2(e3) {
          return n2.computeStyle(e3, {
            strokeLinecap: "round",
        ...
        function h2(e3) {
          return n2.computeStyle(e3, ["no-fill"], {
            strokeLinecap: "round",
            strokeLinejoin: "round",
            stroke: de,
            strokeWidth: 2,
        ...
        function d2(e3, t3, n3, i3) {
          ...
          return (
            (function (e4, t4, n4, i4, r4) {
              if ("sequenceflow-end" === n4) {
                m2(t4, {
                  element: q("path", {
                    d: "M 1 5 L 11 10 L 1 15 Z",
                    ...u2({ fill: r4, stroke: r4, strokeWidth: 1 }),
                  }),
                  ref: { x: 11, y: 10 },
                  scale: 0.5,
                  parentGfx: e4,
        ...
        var O2 = function (e3, t3, n3 = {}, r3) {
            return w2(
              e3,
              i2.getScaledPath("EVENT_MESSAGE", {
                xScaleFactor: 0.9,
                yScaleFactor: 0.9,
                containerWidth: t3.width,
                containerHeight: t3.height,
                position: { mx: 0.235, my: 0.315 },
              }),
              {
                fill: r3 ? xe(t3, p2, n3.stroke) : ve(t3, l2, n3.fill),
                stroke: r3 ? ve(t3, l2, n3.fill) : xe(t3, p2, n3.stroke),
                strokeWidth: 1,
              },
            );
          },
          T2 = function (e3, t3, n3 = {}) {
            var r3 = y2(e3, t3.width, t3.height, 0.2 * t3.height, {
              fill: ve(t3, l2, n3.fill),
              stroke: xe(t3, p2, n3.stroke),
              strokeWidth: 2,
            });
            w2(
              e3,
              i2.getScaledPath("EVENT_TIMER_WH", {
                xScaleFactor: 0.75,
                yScaleFactor: 0.75,
                containerWidth: t3.width,
                containerHeight: t3.height,
              ...
              { stroke: xe(t3, p2, n3.stroke), strokeWidth: 2 },
            );
            for (var o3 = 0; o3 < 12; o3++) {
              var a2 = i2.getScaledPath("EVENT_TIMER_LINE", {
                  xScaleFactor: 0.75,
                  yScaleFactor: 0.75,
                  containerWidth: t3.width,
                  containerHeight: t3.height,
          ...
          N2 = function (e3, t3, n3 = {}, r3) {
            return w2(
              e3,
              i2.getScaledPath("EVENT_ESCALATION", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
          ...
          D2 = function (e3, t3, n3 = {}) {
            return w2(
              e3,
              i2.getScaledPath("EVENT_CONDITIONAL", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
          ...
          F2 = function (e3, t3, n3 = {}, r3) {
            var o3 = w2(
              e3,
              i2.getScaledPath("EVENT_CANCEL_45", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
              ...
              {
                fill: r3 ? xe(t3, p2, n3.stroke) : "none",
                stroke: xe(t3, p2, n3.stroke),
                strokeWidth: 1,
              },
            );
          ...
          V2 = function (e3, t3, n3 = {}, r3) {
            return w2(
              e3,
              i2.getScaledPath("EVENT_COMPENSATION", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
          ...
          G2 = function (e3, t3, n3 = {}, r3) {
            return w2(
              e3,
              i2.getScaledPath("EVENT_MULTIPLE", {
                xScaleFactor: 1.1,
                yScaleFactor: 1.1,
                containerWidth: t3.width,
                containerHeight: t3.height,
          ...
          H2 = function (e3, t3, n3 = {}) {
            return w2(
              e3,
              i2.getScaledPath("EVENT_PARALLEL_MULTIPLE", {
                xScaleFactor: 1.2,
                yScaleFactor: 1.2,
                containerWidth: t3.width,
                containerHeight: t3.height,
          ...
          K2 = function (e3, t3, n3 = {}) {
            return y2(e3, t3.width, t3.height, 8, {
              fill: xe(t3, p2, n3.stroke),
              stroke: xe(t3, p2, n3.stroke),
              strokeWidth: 4,
            });
          };
        function U2(e3, t3, n3 = {}) {
          var i3 = k(e3),
            r3 = (function (e4) {
              return (
                "bpmn:IntermediateThrowEvent" === e4.$type ||
                "bpmn:EndEvent" === e4.$type
              );
            })(i3);
          return i3.get("eventDefinitions") &&
            i3.get("eventDefinitions").length > 1
            ? i3.get("parallelMultiple")
              ? H2(t3, e3, n3, r3)
              : G2(t3, e3, n3, r3)
            : ge(i3, "bpmn:MessageEventDefinition")
              ? O2(t3, e3, n3, r3)
              : ge(i3, "bpmn:TimerEventDefinition")
                ? T2(t3, e3, n3, r3)
                : ge(i3, "bpmn:ConditionalEventDefinition")
                  ? D2(t3, e3, n3, r3)
                  : ge(i3, "bpmn:SignalEventDefinition")
                    ? $2(t3, e3, n3, r3)
                    : ge(i3, "bpmn:EscalationEventDefinition")
                      ? N2(t3, e3, n3, r3)
                      : ge(i3, "bpmn:LinkEventDefinition")
                        ? B2(t3, e3, n3, r3)
                        : ge(i3, "bpmn:ErrorEventDefinition")
                          ? j2(t3, e3, n3, r3)
                          : ge(i3, "bpmn:CancelEventDefinition")
                            ? F2(t3, e3, n3, r3)
                            : ge(i3, "bpmn:CompensateEventDefinition")
                              ? V2(t3, e3, n3, r3)
                              : ge(i3, "bpmn:TerminateEventDefinition")
                                ? K2(t3, e3, n3, r3)
                                : null;
        }
        var Y2 = {
          ParticipantMultiplicityMarker: function (e3, t3, n3 = {}) {
            var r3 = Ee(t3, n3),
              o3 = _e(t3, n3);
            b2(
              "participant-multiplicity",
              e3,
              i2.getScaledPath("MARKER_PARALLEL", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: r3,
                containerHeight: o3,
                position: { mx: (r3 / 2 - 6) / r3, my: (o3 - 15) / o3 },
              }),
              {
                strokeWidth: 2,
                fill: ve(t3, l2, n3.fill),
          ...
          SubProcessMarker: function (e3, t3, n3 = {}) {
            (Je(
              ...
              b2(
                "sub-process",
                e3,
                i2.getScaledPath("MARKER_SUB_PROCESS", {
                  xScaleFactor: 1.5,
                  yScaleFactor: 1.5,
                  containerWidth: t3.width,
                  containerHeight: t3.height,
                  position: {
                    mx: (t3.width / 2 - 7.5) / t3.width,
                    my: (t3.height - 20) / t3.height,
                  },
                }),
          ...
          SequentialMarker: function (e3, t3, n3) {
            b2(
              "sequential",
              e3,
              i2.getScaledPath("MARKER_SEQUENTIAL", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
                position: {
                  mx: (t3.width / 2 + n3.seq) / t3.width,
                  my: (t3.height - 19) / t3.height,
                },
              }),
              { fill: ve(t3, l2, n3.fill), stroke: xe(t3, p2, n3.stroke) },
            );
          ...
          CompensationMarker: function (e3, t3, n3) {
            b2(
              "compensation",
              e3,
              i2.getScaledPath("MARKER_COMPENSATION", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
                position: {
                  mx: (t3.width / 2 + n3.compensation) / t3.width,
                  my: (t3.height - 13) / t3.height,
                },
              }),
              {
                strokeWidth: 1,
          ...
          LoopMarker: function (e3, t3, n3) {
            ...
            b2(
              "loop",
              e3,
              i2.getScaledPath("MARKER_LOOP", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: r3,
                containerHeight: o3,
                position: { mx: (r3 / 2 + n3.loop) / r3, my: (o3 - 7) / o3 },
              }),
              {
                strokeWidth: 1.5,
                fill: "none",
          ...
          AdhocMarker: function (e3, t3, n3) {
            ...
            b2(
              "adhoc",
              e3,
              i2.getScaledPath("MARKER_ADHOC", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: r3,
                containerHeight: o3,
                position: { mx: (r3 / 2 + n3.adhoc) / r3, my: (o3 - 15) / o3 },
              }),
              {
                strokeWidth: 1,
                fill: xe(t3, p2, n3.stroke),
        ...
        function Z2(e3, t3, n3, i3 = {}) {
          ...
          var r3 = k(t3),
            o3 = n3 && n3.includes("SubProcessMarker");
          ((i3 = o3
            ? {
                ...i3,
                seq: -21,
            ...
            r3.get("isForCompensation") && X2("CompensationMarker", e3, t3, i3),
            R(r3, "bpmn:AdHocSubProcess") && X2("AdhocMarker", e3, t3, i3));
          var a2 = r3.get("loopCharacteristics"),
            s3 = a2 && a2.get("isSequential");
          a2 &&
            (void 0 === s3 && X2("LoopMarker", e3, t3, i3),
            false === s3 && X2("ParallelMarker", e3, t3, i3),
            true === s3 && X2("SequentialMarker", e3, t3, i3));
        }
        ...
        function ee2(e3, t3, n3, i3 = {}) {
          var r3 = k(t3),
            o3 = be(
              { x: t3.x, y: t3.y, width: t3.width, height: t3.height },
              i3,
            );
          return Q2(e3, r3.name, {
            align: n3,
            box: o3,
            padding: 7,
            style: { fill: we(t3, c2, p2, i3.stroke) },
          });
        }
        function te2(e3, t3, n3, i3 = {}) {
          var r3 = P(n3),
            o3 = Q2(e3, t3, {
              box: { height: 30, width: r3 ? _e(n3, i3) : Ee(n3, i3) },
              align: "center-middle",
              style: { fill: we(n3, c2, p2, i3.stroke) },
            });
          r3 && Ze(o3, 0, -(-1 * _e(n3, i3)), 270);
        }
        function ne2(e3, t3, n3 = {}) {
          var { width: i3, height: r3 } = be(t3, n3);
          return g2(e3, i3, r3, 10, {
            ...n3,
            fill: ve(t3, l2, n3.fill),
            fillOpacity: nt,
            stroke: xe(t3, p2, n3.stroke),
        ...
        function ie2(e3, t3, n3 = {}) {
          var i3 = k(t3),
            r3 = ve(t3, l2, n3.fill),
            o3 = xe(t3, p2, n3.stroke);
          return (
            ("One" !== i3.get("associationDirection") &&
              "Both" !== i3.get("associationDirection")) ||
              (n3.markerEnd = d2(e3, "association-end", r3, o3)),
            "Both" === i3.get("associationDirection") &&
              (n3.markerStart = d2(e3, "association-start", r3, o3)),
            (n3 = rt(n3, ["markerStart", "markerEnd"])),
            x2(e3, t3.waypoints, { ...n3, stroke: o3, strokeDasharray: "0, 5" })
          );
        }
        function re2(e3, t3, n3 = {}) {
          var r3 = ve(t3, l2, n3.fill),
            o3 = xe(t3, p2, n3.stroke),
            a2 = w2(
              e3,
              i2.getScaledPath("DATA_OBJECT_PATH", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
              ...
              { fill: r3, fillOpacity: nt, stroke: o3 },
            );
          (function (e4) {
            ...
            w2(
              e3,
              i2.getScaledPath("DATA_OBJECT_COLLECTION_PATH", {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: t3.width,
                containerHeight: t3.height,
                position: { mx: 0.33, my: (t3.height - 18) / t3.height },
              }),
              { strokeWidth: 2, fill: r3, stroke: o3 },
            );
          return a2;
        }
        function oe2(e3, t3, n3 = {}) {
          return y2(e3, t3.width, t3.height, {
            fillOpacity: nt,
            ...n3,
            fill: ve(t3, l2, n3.fill),
            stroke: xe(t3, p2, n3.stroke),
        ...
        function le2(e3, t3, n3 = {}) {
          var i3 = g2(e3, Ee(t3, n3), _e(t3, n3), 0, {
              fill: ve(t3, l2, n3.fill),
              fillOpacity: n3.fillOpacity || nt,
              stroke: xe(t3, p2, n3.stroke),
              strokeWidth: 1.5,
            }),
            r3 = k(t3);
        ...
        function pe3(e3, t3, n3 = {}) {
          ...
          var r3 = M(t3);
          return (
            ee2(e3, t3, r3 ? "center-top" : "center-middle", n3),
            Z2(e3, t3, r3 ? void 0 : ["SubProcessMarker"], n3),
            i3
          );
        }
        ...
        var ue2 = (this.handlers = {
          "bpmn:AdHocSubProcess": function (e3, t3, n3 = {}) {
            return pe3(
              e3,
              t3,
              (n3 = M(t3)
                ? rt(n3, ["fill", "stroke", "width", "height"])
                : rt(n3, ["fill", "stroke"])),
            );
          },
          ...
          "bpmn:BoundaryEvent": function (e3, t3, n3 = {}) {
            ...
            ((n3 = {
              ...
              r3 || (n3.strokeDasharray = "6"));
            var o3 = oe2(e3, t3, n3);
            return (
              y2(e3, t3.width, t3.height, 3, { ...n3, fill: "none" }),
              i3 && U2(t3, e3, n3),
              o3
            );
          },
          "bpmn:BusinessRuleTask": function (e3, t3, n3 = {}) {
            ...
            return (
              W(
                w2(
                  e3,
                  i2.getScaledPath("TASK_TYPE_BUSINESS_RULE_MAIN", {
                    abspos: { x: 8, y: 8 },
                  }),
                ),
                {
              ...
              W(
                w2(
                  e3,
                  i2.getScaledPath("TASK_TYPE_BUSINESS_RULE_HEADER", {
                    abspos: { x: 8, y: 8 },
                  }),
                ),
                {
          ...
          "bpmn:ComplexGateway": function (e3, t3, n3 = {}) {
            ...
            return (
              w2(
                e3,
                i2.getScaledPath("GATEWAY_COMPLEX", {
                  xScaleFactor: 0.5,
                  yScaleFactor: 0.5,
                  containerWidth: t3.width,
                  containerHeight: t3.height,
          ...
          "bpmn:DataInput": function (e3, t3, n3 = {}) {
            n3 = rt(n3, ["fill", "stroke"]);
            var r3 = i2.getRawPath("DATA_ARROW"),
              o3 = re2(e3, t3, n3);
            return (
              w2(e3, r3, {
                fill: "none",
          ...
          "bpmn:DataObjectReference": S2("bpmn:DataObject"),
          "bpmn:DataOutput": function (e3, t3, n3 = {}) {
            n3 = rt(n3, ["fill", "stroke"]);
            var r3 = i2.getRawPath("DATA_ARROW"),
              o3 = re2(e3, t3, n3);
            return (
          ...
          "bpmn:EventBasedGateway": function (e3, t3, n3 = {}) {
            ...
            var r3 = k(t3),
              o3 = ae2(e3, t3, n3);
            y2(e3, t3.width, t3.height, 0.2 * t3.height, {
              fill: ve(t3, "none", n3.fill),
              stroke: xe(t3, p2, n3.stroke),
              strokeWidth: 1,
            });
            var a2 = r3.get("eventGatewayType"),
              s3 = !!r3.get("instantiate");
            if ("Parallel" === a2) {
              var l3 = i2.getScaledPath("GATEWAY_PARALLEL", {
                xScaleFactor: 0.4,
                yScaleFactor: 0.4,
                containerWidth: t3.width,
                containerHeight: t3.height,
              ...
              "Exclusive" === a2 &&
                (s3 ||
                  y2(e3, t3.width, t3.height, 0.26 * t3.height, {
                    fill: "none",
                    stroke: xe(t3, p2, n3.stroke),
                    strokeWidth: 1,
                  }),
                (function () {
                  var r4 = i2.getScaledPath("GATEWAY_EVENT_BASED", {
                    xScaleFactor: 0.18,
                    yScaleFactor: 0.18,
                    containerWidth: t3.width,
                    containerHeight: t3.height,
          ...
          "bpmn:ExclusiveGateway": function (e3, t3, n3 = {}) {
            var r3 = ae2(e3, t3, (n3 = rt(n3, ["fill", "stroke"]))),
              o3 = i2.getScaledPath("GATEWAY_EXCLUSIVE", {
                xScaleFactor: 0.4,
                yScaleFactor: 0.4,
                containerWidth: t3.width,
                containerHeight: t3.height,
          ...
          "bpmn:InclusiveGateway": function (e3, t3, n3 = {}) {
            ...
            return (
              y2(e3, t3.width, t3.height, 0.24 * t3.height, {
                fill: ve(t3, l2, n3.fill),
                stroke: xe(t3, p2, n3.stroke),
                strokeWidth: 2.5,
              }),
          ...
          "bpmn:IntermediateCatchEvent": S2("bpmn:IntermediateEvent"),
          "bpmn:IntermediateThrowEvent": S2("bpmn:IntermediateEvent"),
          "bpmn:Lane": function (e3, t3, n3 = {}) {
            return (
              (n3 = rt(n3, ["fill", "stroke", "width", "height"])),
              le2(e3, t3, { ...n3, fillOpacity: 0.25 })
            );
          },
          "bpmn:ManualTask": function (e3, t3, n3 = {}) {
            ...
            return (
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_MANUAL", {
                  abspos: { x: 17, y: 15 },
                }),
                {
                  fill: ve(t3, l2, n3.fill),
          ...
          "bpmn:MessageFlow": function (e3, t3, n3 = {}) {
            ...
            var r3 = k(t3),
              o3 = C(t3),
              a2 = ve(t3, l2, n3.fill),
              s3 = xe(t3, p2, n3.stroke),
              c3 = x2(e3, t3.waypoints, {
                markerEnd: d2(e3, "messageflow-end", a2, s3),
                markerStart: d2(e3, "messageflow-start", a2, s3),
                stroke: s3,
                strokeDasharray: "10, 11",
                strokeWidth: 1.5,
              });
            if (r3.get("messageRef")) {
              var u3 = c3.getPointAtLength(c3.getTotalLength() / 2),
                h3 = i2.getScaledPath("MESSAGE_FLOW_MARKER", {
                  abspos: { x: u3.x, y: u3.y },
                }),
                f2 = { strokeWidth: 1 };
              "initiating" === o3.get("messageVisibleKind")
                ? ((f2.fill = a2), (f2.stroke = s3))
                : ((f2.fill = s3), (f2.stroke = a2));
              var m3 = w2(e3, h3, f2),
                y3 = Q2(e3, r3.get("messageRef").get("name"), {
                  align: "center-top",
                  fitBox: true,
                  style: { fill: s3 },
                }),
          ...
          "bpmn:ParallelGateway": function (e3, t3, n3 = {}) {
            ...
            return (
              w2(
                e3,
                i2.getScaledPath("GATEWAY_PARALLEL", {
                  xScaleFactor: 0.6,
                  yScaleFactor: 0.6,
                  containerWidth: t3.width,
                  containerHeight: t3.height,
          ...
          "bpmn:Participant": function (e3, t3, n3 = {}) {
            ...
            if (r3) {
              (v2(
                ...
                { stroke: xe(t3, p2, n3.stroke), strokeWidth: 1.5 },
              ),
                te2(e3, s3, t3, n3));
            } else {
              var l3 = be(t3, n3);
              ...
              var u3 = Q2(e3, s3, {
                box: l3,
                align: "center-middle",
                style: { fill: we(t3, c2, p2, n3.stroke) },
              });
              if (!o3) Ze(u3, 0, -(-1 * _e(t3, n3)), 270);
            }
            return (
              a2.get("participantMultiplicity") &&
                X2("ParticipantMultiplicityMarker", e3, t3, n3),
              i3
            );
          },
            ...
            return (
              o3.get("instantiate")
                ? (y2(e3, 28, 28, 4.4, {
                  ...
                  (r3 = i2.getScaledPath("TASK_TYPE_INSTANTIATING_SEND", {
                    abspos: { x: 7.77, y: 9.52 },
                  })))
                : (r3 = i2.getScaledPath("TASK_TYPE_SEND", {
                    xScaleFactor: 0.9,
                    yScaleFactor: 0.9,
                    containerWidth: 21,
                    containerHeight: 14,
          ...
          "bpmn:ScriptTask": function (e3, t3, n3 = {}) {
            ...
            return (
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_SCRIPT", {
                  abspos: { x: 15, y: 20 },
                }),
                {
                  fill: ve(t3, l2, n3.fill),
          ...
          "bpmn:SendTask": function (e3, t3, n3 = {}) {
            ...
            return (
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_SEND", {
                  xScaleFactor: 1,
                  yScaleFactor: 1,
                  containerWidth: 21,
                  containerHeight: 14,
          ...
          "bpmn:SequenceFlow": function (e3, t3, n3 = {}) {
            n3 = rt(n3, ["fill", "stroke"]);
            var i3 = ve(t3, l2, n3.fill),
              r3 = xe(t3, p2, n3.stroke),
              o3 = x2(e3, t3.waypoints, {
                markerEnd: d2(e3, "sequenceflow-end", i3, r3),
                stroke: r3,
              }),
              a2 = k(t3),
              { source: s3 } = t3;
            if (s3) {
              var c3 = k(s3);
              (a2.get("conditionExpression") &&
                R(c3, "bpmn:Activity") &&
                W(o3, {
                  markerStart: d2(e3, "conditional-flow-marker", i3, r3),
                }),
                c3.get("default") &&
                  (R(c3, "bpmn:Gateway") || R(c3, "bpmn:Activity")) &&
                  c3.get("default") === a2 &&
                  W(o3, {
                    markerStart: d2(
                      e3,
          ...
          "bpmn:ServiceTask": function (e3, t3, n3 = {}) {
            ...
            return (
              ...
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_SERVICE", {
                  abspos: { x: 12, y: 18 },
                }),
                {
                  fill: ve(t3, l2, n3.fill),
          ...
          "bpmn:StartEvent": function (e3, t3, n3 = {}) {
            var { renderIcon: i3 = true } = n3;
            ((n3 = rt(n3, ["fill", "stroke"])),
              k(t3).get("isInterrupting") ||
                (n3 = { ...n3, strokeDasharray: "6" }));
            var r3 = oe2(e3, t3, n3);
            return (i3 && U2(t3, e3, n3), r3);
          },
          ...
          "bpmn:TextAnnotation": function (e3, t3, n3 = {}) {
            n3 = rt(n3, ["fill", "stroke", "width", "height"]);
            var { width: r3, height: o3 } = be(t3, n3),
              a2 = g2(e3, r3, o3, 0, 0, { fill: "none", stroke: "none" });
            return (
              w2(
                e3,
                i2.getScaledPath("TEXT_ANNOTATION", {
                  xScaleFactor: 1,
                  yScaleFactor: 1,
                  containerWidth: r3,
                  containerHeight: o3,
          ...
          "bpmn:Transaction": function (e3, t3, i3 = {}) {
            i3 = M(t3)
              ? rt(i3, ["fill", "stroke", "width", "height"])
              : rt(i3, ["fill", "stroke"]);
            var r3 = pe3(e3, t3, { strokeWidth: 1.5, ...i3 }),
              o3 = n2.style(["no-fill", "no-events"], {
                stroke: xe(t3, p2, i3.stroke),
                strokeWidth: 1.5,
              });
            return (
              M(t3) || (i3 = {}),
              g2(e3, Ee(t3, i3), _e(t3, i3), 7, 3, o3),
              r3
            );
          },
          "bpmn:UserTask": function (e3, t3, n3 = {}) {
            ...
            return (
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_USER_1", {
                  abspos: { x: 15, y: 12 },
                }),
                {
                  fill: ve(t3, l2, n3.fill),
              ...
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_USER_2", {
                  abspos: { x: 15, y: 12 },
                }),
                {
                  fill: ve(t3, l2, n3.fill),
              ...
              w2(
                e3,
                i2.getScaledPath("TASK_TYPE_USER_3", {
                  abspos: { x: 15, y: 12 },
                }),
                {
                  fill: xe(t3, p2, n3.stroke),
          ...
          label: function (e3, t3, n3 = {}) {
            return (function (e4, t4, n4 = {}) {
              ...
              return Q2(e4, L(t4), {
                box: i3,
                fitBox: true,
                style: E({}, o2.getExternalStyle(), {
                  fill: we(t4, c2, p2, n4.stroke),
                }),
              });
            })(e3, t3, n3);
          },
      ...
      (e(it, A),
        ...
        (it.prototype.getShapePath = function (e2) {
          return R(e2, "bpmn:Event")
            ? (function (e3) {
                var t2 = e3.x + e3.width / 2,
                  n2 = e3.y + e3.height / 2,
                  i2 = e3.width / 2;
                return le([
                  ["M", t2, n2],
                  ["m", 0, -i2],
                  ["a", i2, i2, 0, 1, 1, 0, 2 * i2],
                  ["a", i2, i2, 0, 1, 1, 0, -2 * i2],
                  ["z"],
                ]);
              })(e2)
      ...
      function st(e2, t2) {
        ...
        try {
          var i2,
            r2 = "" === e2;
          return (
            (t2.textContent = r2 ? "dummy" : e2),
            (i2 = {
              width: (n2 = t2.getBBox()).width + 2 * n2.x,
              height: n2.height,
            }),
            r2 && (i2.width = 0),
            i2
      ...
      function lt(e2, t2, n2) {
        for (var i2, r2 = e2.shift(), o2 = r2; ; ) {
          if (
            (((i2 = st(o2, n2)).width = o2 ? i2.width : 0),
            " " === o2 ||
              "" === o2 ||
              i2.width < Math.round(t2) ||
              o2.length < 2)
          )
            return pt(e2, o2, r2, i2);
      ...
      function ut(e2, t2, n2) {
        var i2 = Math.max(e2.length * (n2 / t2), 1),
          r2 = (function (e3, t3) {
            var n3,
              i3 = e3.split(/(\s|-|\u00AD)/g),
              r3 = [],
      ...
      function ht(e2) {
        this._config = E(
          {},
          { size: at, padding: ot, style: {}, align: "center-top" },
          e2 || {},
        );
      }
      ((ht.prototype.createText = function (e2, t2) {
        ...
        (ht.prototype.layoutText = function (e2, t2) {
          var n2 = E({}, this._config.size, t2.box),
            i2 = E({}, this._config.style, t2.style),
            r2 = (function (e3) {
              var t3 = e3.split("-");
              return {
                horizontal: t3[0] || "center",
                vertical: t3[1] || "top",
              };
            })(t2.align || this._config.align),
            o2 = (function (e3) {
              return a(e3)
                ? E({ top: 0, left: 0, right: 0, bottom: 0 }, e3)
                : { top: e3, left: e3, right: e3, bottom: e3 };
            })(void 0 !== t2.padding ? t2.padding : this._config.padding),
            s2 = t2.fitBox || false,
            l2 = (function (e3) {
              if ("fontSize" in e3 && "lineHeight" in e3)
                return e3.lineHeight * parseInt(e3.fontSize, 10);
            })(i2),
            p2 = e2.split(/\u00AD?\r?\n/),
            c2 = [],
            u2 = n2.width - o2.left - o2.right,
            h2 = q("text");
          for (
            W(h2, { x: 0, y: 0 }),
              W(h2, i2),
          ...
          var d2 =
            ...
            g2 = o2.top;
          ("middle" === r2.vertical && (g2 += (n2.height - d2) / 2),
            (g2 -= (l2 || c2[0].height) / 4));
          var v2 = q("text");
          return (
            W(v2, i2),
            ...
            oe(h2),
            { dimensions: { width: y2, height: d2 }, element: v2 }
          );
        }));
      function ft(e2) {
        var t2 = E(
          ...
          n2 = parseInt(t2.fontSize, 10) - 1,
          i2 = E({}, t2, { fontSize: n2 }, (e2 && e2.externalStyle) || {}),
          r2 = new ht({ style: t2 });
        ((this.getExternalLabelBounds = function (e3, t3) {
          var n3 = r2.getDimensions(t3, {
            box: { width: 90, height: 30 },
            style: i2,
          });
          return {
            x: Math.round(e3.x + e3.width / 2 - n3.width / 2),
            y: Math.round(e3.y),
            width: Math.ceil(n3.width),
            height: Math.ceil(n3.height),
          };
        }),
          (this.getTextAnnotationBounds = function (e3, n3) {
            var i3 = r2.getDimensions(n3, {
              box: e3,
              style: t2,
              align: "left-top",
              padding: 5,
            ...
            return {
              ...
              y: e3.y,
              width: e3.width,
              height: Math.max(30, Math.round(i3.height)),
            };
          }),
      ...
      var yt = {
        ...
        bpmnRenderer: ["type", it],
        textRenderer: ["type", ft],
        pathMap: [
          "type",
          function () {
            ((this.pathMap = {
              ...
              EVENT_CONDITIONAL: {
                ...
                width: 36,
                heightElements: [
                  8.5, 14.5, 18, 11.5, 14.5, 17.5, 20.5, 23.5, 26.5,
                ],
              ...
              (this.getScaledPath = function (e2, t2) {
                var n2,
                  ...
                  r2 = this.pathMap[e2];
                t2.abspos
                  ? ((n2 = t2.abspos.x), (i2 = t2.abspos.y))
                  : ((n2 = t2.containerWidth * t2.position.mx),
                    (i2 = t2.containerHeight * t2.position.my));
                var o2 = {};
                if (t2.position) {
                  for (
                    var a2 = (t2.containerHeight / r2.height) * t2.yScaleFactor,
                      s2 = (t2.containerWidth / r2.width) * t2.xScaleFactor,
                      l2 = 0;
                    l2 < r2.heightElements.length;
                    l2++
                  )
                    o2["y" + l2] = r2.heightElements[l2] * a2;
                  for (var p2 = 0; p2 < r2.widthElements.length; p2++)
                    o2["x" + p2] = r2.widthElements[p2] * s2;
                }
                var c2,
                  u2,
                  h2 =
                    ((c2 = r2.d),
                    (u2 = { mx: n2, my: i2, e: o2 }),
                    String(c2).replace(mt, function (e3, t3) {
                      return (function (e4, t4, n3) {
                        var i3 = n3;
                        return (
                          t4.replace(dt, function (e5, t5, n4, r3, o3) {
                            ((t5 = t5 || r3),
                              i3 &&
                                (t5 in i3 && (i3 = i3[t5]),
                                "function" == typeof i3 && o3 && (i3 = i3())));
                          }),
      ...
      function vt(e2) {
        return {
          top: e2.y,
          right: e2.x + (e2.width || 0),
          bottom: e2.y + (e2.height || 0),
          left: e2.x,
        };
      }
      function xt(e2) {
      ...
      function wt(e2) {
        for (
          var t2 = e2.waypoints,
            n2 = t2.reduce(function (e3, n3, i3) {
              var r3,
                o3,
                a3 = t2[i3 - 1];
              if (a3) {
                var s2 = e3[e3.length - 1],
                  l2 = (s2 && s2.endLength) || 0,
                  p2 =
                    ((r3 = a3),
                    (o3 = n3),
                    Math.sqrt(
                      Math.pow(r3.x - o3.x, 2) + Math.pow(r3.y - o3.y, 2),
                    ));
                e3.push({
                  start: a3,
                  end: n3,
        ...
        return {
          x: o2.start.x + (o2.end.x - o2.start.x) * a2,
          y: o2.start.y + (o2.end.y - o2.start.y) * a2,
        };
      }
      function bt(e2) {
      ...
      function Rt(e2, t2, n2) {
        return new Error(
          `element ${Et(t2)} referenced by ${Et(e2)}#${n2} not yet drawn`,
        );
      }
      function St(e2, t2, n2, i2, r2) {
        ((this._eventBus = e2),
          (this._canvas = t2),
          (this._elementFactory = n2),
          (this._elementRegistry = i2),
          (this._textRenderer = r2));
      }
      ((St.$inject = [
        "eventBus",
        "canvas",
        ...
        (St.prototype.add = function (e2, t2, n2) {
          var i2, r2, o2, a2, s2, l2, p2;
          if (R(t2, "bpmndi:BPMNPlane")) {
            var c2 = R(e2, "bpmn:SubProcess") ? { id: e2.id + "_plane" } : {};
            ((i2 = this._elementFactory.createRoot(_t(e2, t2, c2))),
              this._canvas.addRootElement(i2));
            ...
            var f2 = t2.bounds;
            ((i2 = this._elementFactory.createShape(
              _t(e2, t2, {
                collapsed: u2,
                hidden: r2,
                x: Math.round(f2.x),
              ...
              R(e2, "bpmn:BoundaryEvent") && this._attachBoundary(e2, i2),
              R(e2, "bpmn:Lane") && (o2 = 0),
              R(e2, "bpmn:DataStoreReference") &&
                ((a2 = n2),
                (s2 = bt(f2)),
                (l2 = s2.x),
                (p2 = s2.y),
                (l2 >= a2.x &&
                  ...
                  p2 >= a2.y &&
                  p2 <= a2.y + a2.height) ||
                  (n2 = this._canvas.findRoot(n2))),
              this._canvas.addShape(i2, n2, o2));
          } else {
            if (!R(t2, "bpmndi:BPMNEdge"))
              throw new Error(`unknown di ${Et(t2)} for element ${Et(e2)}`);
            var m2 = this._getSource(e2),
              d2 = this._getTarget(e2);
            ((r2 = n2 && (n2.hidden || n2.collapsed)),
              (i2 = this._elementFactory.createConnection(
                _t(e2, t2, {
                  hidden: r2,
                  source: m2,
                  target: d2,
                  waypoints: At(t2, m2, d2),
                }),
              )),
              R(e2, "bpmn:DataAssociation") && (n2 = this._canvas.findRoot(n2)),
              this._canvas.addConnection(i2, n2, o2));
          }
          return (
            (function (e3) {
              return (
                R(e3, "bpmn:Event") ||
                R(e3, "bpmn:Gateway") ||
                R(e3, "bpmn:DataStoreReference") ||
                R(e3, "bpmn:DataObjectReference") ||
                R(e3, "bpmn:DataInput") ||
                R(e3, "bpmn:DataOutput") ||
                R(e3, "bpmn:SequenceFlow") ||
                R(e3, "bpmn:MessageFlow") ||
              ...
              L(i2) &&
              this.addLabel(e2, t2, i2),
            this._eventBus.fire("bpmnElement.added", { element: i2 }),
            i2
          );
        }),
        (St.prototype._attachBoundary = function (e2, t2) {
          ...
          var i2 = this._elementRegistry.get(n2.id),
            r2 = i2 && i2.attachers;
          if (!i2) throw Rt(e2, n2, "attachedToRef");
          ((t2.host = i2),
            r2 || (i2.attachers = r2 = []),
            -1 === r2.indexOf(t2) && r2.push(t2));
        }),
        (St.prototype.addLabel = function (e2, t2, n2) {
          ...
          return (
            (i2 = B(t2, n2)),
            (r2 = L(n2)) &&
              (i2 = this._textRenderer.getExternalLabelBounds(i2, r2)),
            (o2 = this._elementFactory.createLabel(
              _t(e2, t2, {
                id: e2.id + "_label",
                labelTarget: n2,
                type: "label",
                hidden: n2.hidden || !L(n2),
                x: Math.round(i2.x),
                y: Math.round(i2.y),
                width: Math.round(i2.width),
                height: Math.round(i2.height),
              }),
            )),
            this._canvas.addShape(o2, n2.parent)
          );
        }),
        (St.prototype._getConnectedElement = function (e2, t2) {
          ...
          if (
            ((i2 = e2[t2 + "Ref"]),
            "source" === t2 &&
              "bpmn:DataInputAssociation" === r2 &&
              (i2 = i2 && i2[0]),
            (("source" === t2 && "bpmn:DataOutputAssociation" === r2) ||
              ("target" === t2 && "bpmn:DataInputAssociation" === r2)) &&
              (i2 = e2.$parent),
            (n2 = i2 && this._getElement(i2)))
          )
            return n2;
          throw i2
            ? Rt(e2, i2, t2 + "Ref")
            : new Error(`${Et(e2)}#${t2} Ref not specified`);
        }),
      ...
      var kt = {
        __depends__: [yt, { __depends__: [gt], bpmnImporter: ["type", St] }],
      };
      function Ct(e2, t2) {
        var n2, i2, r2, a2;
        return (
          ...
          f(e2, function (e3) {
            ...
            var s2 = o2.x,
              ...
              p2 = o2.height || 0,
              c2 = o2.width || 0;
            ((s2 < n2 || void 0 === n2) && (n2 = s2),
              (l2 < i2 || void 0 === i2) && (i2 = l2),
              (s2 + c2 > r2 || void 0 === r2) && (r2 = s2 + c2),
              (l2 + p2 > a2 || void 0 === a2) && (a2 = l2 + p2));
          }),
      ...
      function Ot(e2) {
        ((this._counter = 0),
          (this._prefix =
            (e2 ? e2 + "-" : "") + Math.floor(1e9 * Math.random()) + "-"));
      }
      ...
      function Nt(e2, t2, n2, i2) {
        ...
        ((this._eventBus = t2),
          ...
          (this._elementRegistry = i2),
          (this._ids = Tt),
          (this._overlayDefaults = E(
            { show: null, scale: true },
            e2 && e2.defaults,
          )),
          (this._overlays = {}),
          ...
          (this._overlayRoot =
            ((r2 = n2.getContainer()),
            Oe((o2 = qe('<div class="djs-overlay-container" />')), {
              position: "absolute",
              width: 0,
              height: 0,
            }),
            r2.insertBefore(o2, r2.firstChild),
            o2)),
          this._init());
      }
      ...
      function Lt(e2, t2) {
        ((e2.style["transform-origin"] = "top left"),
          ["", "-ms-", "-webkit-"].forEach(function (n2) {
      ...
      ((Nt.$inject = [
        ...
        (Nt.prototype.get = function (e2) {
          if (
            (p(e2) && (e2 = { id: e2 }),
            p(e2.element) &&
              (e2.element = this._elementRegistry.get(e2.element)),
            e2.element)
          ) {
            var t2 = this._getOverlayContainer(e2.element, true);
            return t2
              ? e2.type
                ? h(t2.overlays, g({ type: e2.type }))
                : t2.overlays.slice()
              : [];
          }
          return e2.type
            ? h(this._overlays, g({ type: e2.type }))
            : e2.id
              ? this._overlays[e2.id]
              : null;
        }),
          ...
          f(t2, function (e3) {
            ...
            if (
              (e3 &&
                (Xe(e3.html),
                Xe(e3.htmlContainer),
                delete e3.htmlContainer,
                delete e3.element,
                delete n2._overlays[e3.id]),
              t3)
            ) {
        ...
        (Nt.prototype._updateOverlay = function (e2) {
          var t2,
            ...
            s2 = i2.top;
          void 0 !== i2.right &&
            ((t2 = o2.waypoints ? Ct(o2).width : o2.width),
            (a2 = -1 * i2.right + t2));
          void 0 !== i2.bottom &&
            ((n2 = o2.waypoints ? Ct(o2).height : o2.height),
            (s2 = -1 * i2.bottom + n2));
          (Dt(r2, a2 || 0, s2 || 0),
            this._updateOverlayVisibilty(e2, this._canvas.viewbox()));
        }),
        (Nt.prototype._createOverlayContainer = function (e2) {
          ...
          return (
            this._updateOverlayContainer(n2),
            this._overlayContainers.push(n2),
            n2
          );
        }),
        (Nt.prototype._updateRoot = function (e2) {
          var t2 = e2.scale || 1,
            n2 =
              "matrix(" +
              [t2, 0, 0, t2, -1 * e2.x * t2, -1 * e2.y * t2].join(",") +
              ")";
        ...
        (Nt.prototype._addOverlay = function (e2) {
          var t2,
            ...
            r2 = e2.element,
            o2 = e2.html;
          (o2.get && o2.constructor.prototype.jquery && (o2 = o2.get(0)),
            p(o2) && (o2 = qe(o2)),
            (n2 = this._getOverlayContainer(r2)),
            Oe(
              (t2 = qe(
                '<div class="djs-overlay" data-overlay-id="' + i2 + '">',
              )),
              { position: "absolute" },
            ),
            t2.appendChild(o2),
            e2.type && Ne(t2).add("djs-overlay-" + e2.type),
            Bt(t2, this._canvas.findRoot(r2) === this._canvas.getRootElement()),
            (e2.htmlContainer = t2),
            n2.overlays.push(e2),
            n2.html.appendChild(t2),
            (this._overlays[i2] = e2),
            this._updateOverlay(e2),
            this._updateOverlayVisibilty(e2, this._canvas.viewbox()));
        }),
        (Nt.prototype._updateOverlayVisibilty = function (e2, t2) {
          var n2 = e2.show,
            i2 = this._canvas.findRoot(e2.element),
            o2 = n2 && n2.minZoom,
            a2 = n2 && n2.maxZoom,
            s2 = e2.htmlContainer,
            l2 = true;
          ((i2 !== this._canvas.getRootElement() ||
            (n2 && ((r(o2) && o2 > t2.scale) || (r(a2) && a2 < t2.scale)))) &&
            (l2 = false),
            Bt(s2, l2),
            this._updateOverlayScale(e2, t2));
        }),
        (Nt.prototype._updateOverlayScale = function (e2, t2) {
          ...
          (true !== a2 &&
            (false === a2
              ? ((n2 = 1), (i2 = 1))
              : ((n2 = a2.min), (i2 = a2.max)),
            r(n2) && t2.scale < n2 && (o2 = (1 / t2.scale || 1) * n2),
            r(i2) && t2.scale > i2 && (o2 = (1 / t2.scale || 1) * i2)),
            r(o2) && (l2 = "scale(" + o2 + "," + o2 + ")"),
            Lt(s2, l2));
        }),
        ...
        (Nt.prototype._init = function () {
          ...
          (e2.on("canvas.viewbox.changing", function (e3) {
            ...
            e2.on("canvas.viewbox.changed", function (e3) {
              ...
              ((n2 = e3.viewbox),
                t2._updateRoot(n2),
                t2._updateOverlaysVisibilty(n2),
                t2.show());
            }),
            ...
            e2.on("element.changed", 500, function (e3) {
              var n2 = e3.element,
                i2 = t2._getOverlayContainer(n2, true);
              i2 &&
                (f(i2.overlays, function (e4) {
      ...
      function jt(e2, t2, n2, i2) {
        (e2.on("element.changed", function (i3) {
          var r2 = i3.element;
          ((r2.parent || r2 === t2.getRootElement()) &&
            (i3.gfx = n2.getGraphics(r2)),
            i3.gfx && e2.fire(Mt(r2) + ".changed", i3));
        }),
      ...
      function Wt(e2) {
        return function (t2, n2, i2, r2, o2) {
          ((l(t2) || s(t2)) &&
            ((o2 = r2), (r2 = i2), (i2 = n2), (n2 = t2), (t2 = null)),
            this.on(t2, e2, n2, i2, r2, o2));
        };
      }
      function $t(e2, t2) {
        (t2.invoke(Vt, this),
          this.executed(function (t3) {
            var n2 = t3.context;
            n2.rootElement
              ? e2.setRootElement(n2.rootElement)
              : (n2.rootElement = e2.getRootElement());
          }),
      ...
      ((Vt.$inject = ["eventBus"]),
        (Vt.prototype.on = function (e2, t2, n2, i2, r2, p2) {
          if (
            ((l(t2) || s(t2)) &&
              ((p2 = r2), (r2 = i2), (i2 = n2), (n2 = t2), (t2 = null)),
            l(n2) && ((p2 = r2), (r2 = i2), (i2 = n2), (n2 = 1e3)),
            a(r2) && ((p2 = r2), (r2 = false)),
            !l(i2))
          )
        ...
        (Vt.prototype.canExecute = Wt("canExecute")),
        (Vt.prototype.preExecute = Wt("preExecute")),
        (Vt.prototype.preExecuted = Wt("preExecuted")),
        (Vt.prototype.execute = Wt("execute")),
        (Vt.prototype.executed = Wt("executed")),
        (Vt.prototype.postExecute = Wt("postExecute")),
        (Vt.prototype.postExecuted = Wt("postExecuted")),
        (Vt.prototype.revert = Wt("revert")),
        (Vt.prototype.reverted = Wt("reverted")),
        e($t, Vt),
        ($t.$inject = ["canvas", "injector"]));
      var zt = {
          __init__: ["rootElementsBehavior"],
          rootElementsBehavior: ["type", $t],
        },
        Gt = {
          "&": "&amp;",
          "<": "&lt;",
      ...
      function Ut(e2, t2, n2) {
        var i2 = qe('<ul class="bjs-breadcrumbs"></ul>'),
          r2 = n2.getContainer(),
          o2 = Ne(r2);
        r2.appendChild(i2);
        var a2 = [];
        function s2(e3) {
          e3 &&
            (a2 = (function (e4) {
              for (var t3 = k(e4), n3 = [], i3 = t3; i3; i3 = i3.$parent)
                (R(i3, "bpmn:SubProcess") || R(i3, "bpmn:Process")) &&
                  n3.push(i3);
              return n3.reverse();
            })(e3));
          ...
          i2.innerHTML = "";
          var s3 = r3.length > 1;
          (o2.toggle("bjs-breadcrumbs-shown", s3),
      ...
      function qt(e2, t2) {
        ...
        (e2.on("root.set", function (e3) {
          var r2 = e3.element,
            ...
            a2 = i2.get(r2);
          if (
            (i2.set(n2, { x: o2.x, y: o2.y, zoom: o2.scale }),
            (n2 = r2),
            R(r2, "bpmn:SubProcess") || a2)
          ) {
            a2 = a2 || { x: 0, y: 0, zoom: 1 };
            var s2 = (o2.x - a2.x) * o2.scale,
              l2 = (o2.y - a2.y) * o2.scale;
            ((0 === s2 && 0 === l2) || t2.scroll({ dx: s2, dy: l2 }),
              a2.zoom !== o2.scale && t2.zoom(a2.zoom, { x: 0, y: 0 }));
          }
        }),
      ...
      function Yt() {
        ((this._entries = []),
          (this.set = function (e2, t2) {
            var n2 = false;
            for (var i2 in this._entries)
              if (this._entries[i2][0] === e2) {
          ...
          (this.get = function (e2) {
            for (var t2 in this._entries)
              if (this._entries[t2][0] === e2) return this._entries[t2][1];
            return null;
          }),
          (this.clear = function () {
          ...
          (this.remove = function (e2) {
            var t2 = -1;
            for (var n2 in this._entries)
              if (this._entries[n2][0] === e2) {
                t2 = n2;
                break;
              }
      ...
      ((Ut.$inject = ["eventBus", "elementRegistry", "canvas"]),
        (qt.$inject = ["eventBus", "canvas"]));
      var Xt = 180,
        Zt = 160;
      function Jt(e2, t2) {
      ...
      ((Jt.prototype._handleImport = function (e2) {
        if (e2.diagrams) {
          ...
          ((this._definitions = e2),
            ...
            e2.diagrams.forEach(function (e3) {
              e3.plane &&
                e3.plane.bpmnElement &&
                (t2._processToDiagramMap[e3.plane.bpmnElement.id] = e3);
            }),
            e2.diagrams
              .filter((e3) => e3.plane)
              .flatMap((e3) => t2._createNewDiagrams(e3.plane))
              .forEach(function (e3) {
        ...
        (Jt.prototype._createNewDiagrams = function (e2) {
          ...
          e2.get("planeElement").forEach(function (t3) {
            ...
            if (r3) {
              var o2 = r3.$parent;
              (R(r3, "bpmn:SubProcess") && !t3.isExpanded && n2.push(r3),
                (function (e3, t4) {
                  var n3 = e3.$parent;
                  if (!R(n3, "bpmn:SubProcess") || n3 === t4.bpmnElement)
                    return false;
                  if (
                    S(e3, [
          ...
          return (
            ...
            i2.forEach(function (e3) {
              for (
                var i3 = e3.diElement, r3 = e3.parent;
                r3 && -1 === n2.indexOf(r3);
        ...
        (Jt.prototype._movePlaneElementsToOrigin = function (e2) {
          var t2 = e2.get("planeElement"),
            n2 = (function (e3) {
              ...
              return (
                e3.planeElement.forEach(function (e4) {
                  if (e4.bounds) {
                    var n3 = vt(e4.bounds);
                    ((t3.top = Math.min(n3.top, t3.top)),
                      (t3.left = Math.min(n3.left, t3.left)));
                  }
                }),
                (function (e4) {
                  return {
          ...
          t2.forEach(function (e3) {
            e3.waypoint
              ? e3.waypoint.forEach(function (e4) {
                  ((e4.x = e4.x - i2), (e4.y = e4.y - r2));
                })
              : e3.bounds &&
                ((e3.bounds.x = e3.bounds.x - i2),
                (e3.bounds.y = e3.bounds.y - r2));
          });
        }),
        ...
        (Jt.prototype._createDiagram = function (e2) {
          var t2 = this._moddle.create("bpmndi:BPMNPlane", { bpmnElement: e2 }),
            n2 = this._moddle.create("bpmndi:BPMNDiagram", { plane: t2 });
          return (
            (t2.$parent = n2),
            (t2.bpmnElement = e2),
            (n2.$parent = this._definitions),
            this._definitions.diagrams.push(n2),
            n2
          );
        }),
      ...
      function tn(e2, t2, n2, i2, r2) {
        ...
        (this.executed(
          ...
          this.executed(
            ...
            function (e3) {
              var t3 = e3.oldParent,
                n3 = e3.newParent || e3.parent,
                i3 = e3.shape;
              (o2._canDrillDown(i3) && o2._addOverlay(i3),
                o2._updateDrilldownOverlay(t3),
                o2._updateDrilldownOverlay(n3),
                o2._updateDrilldownOverlay(i3));
            },
            true,
          ),
          this.reverted(
          ...
          t2.on("import.render.complete", function () {
      ...
      (e(tn, Vt),
        (tn.prototype._updateDrilldownOverlay = function (e2) {
          var t2 = this._canvas;
          if (e2) {
        ...
        (tn.prototype._updateOverlayVisibility = function (e2) {
          var t2 = this._overlays,
            n2 = k(e2),
            i2 = t2.get({ element: n2.id, type: "drilldown" })[0];
          if (i2) {
            var r2 =
              n2 && n2.get("flowElements") && n2.get("flowElements").length;
        ...
        (tn.prototype._addOverlay = function (e2) {
          var t2 = this._canvas,
            n2 = this._overlays,
            i2 = k(e2);
          n2.get({ element: e2, type: "drilldown" }).length &&
            this._removeOverlay(e2);
          var r2 = qe(
              '<button type="button" class="bjs-drilldown"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.81801948,3.50735931 L10.4996894,9.1896894 L10.5,4 L12,4 L12,12 L4,12 L4,10.5 L9.6896894,10.4996894 L3.75735931,4.56801948 C3.46446609,4.27512627 3.46446609,3.80025253 3.75735931,3.50735931 C4.05025253,3.21446609 4.52512627,3.21446609 4.81801948,3.50735931 Z"/></svg></button>',
            ),
            o2 = i2.get("name") || i2.get("id"),
            a2 = this._translate("Open {element}", { element: o2 });
          (r2.setAttribute("title", a2),
            ...
            this._updateOverlayVisibility(e2));
        }),
      ...
      var nn = {
        ...
        drilldownBreadcrumbs: ["type", Ut],
        drilldownCentering: ["type", qt],
        drilldownOverlayBehavior: ["type", tn],
        subprocessCompatibility: ["type", Jt],
      };
      function rn(e2, t2) {
        ((this._eventBus = e2), (this.offset = 5));
        var n2 = t2.cls("djs-outline", ["no-fill"]),
          i2 = this;
        function r2(e3) {
          var t3 = q("rect");
          return (
            W(t3, E({ x: 0, y: 0, rx: 4, width: 100, height: 100 }, n2)),
            t3
          );
        }
        (e2.on(["shape.added", "shape.changed"], 500, function (e3) {
          var t3 = e3.element,
            n3 = e3.gfx,
            o2 = Ye(".djs-outline", n3);
          (o2 || I(n3, (o2 = i2.getOutline(t3) || r2())),
            i2.updateShapeOutline(o2, t3));
        }),
      ...
      ((rn.prototype.updateShapeOutline = function (e2, t2) {
        ...
        (i2.length &&
          ...
          n2 ||
            W(e2, {
              x: -this.offset,
              y: -this.offset,
              width: t2.width + 2 * this.offset,
              height: t2.height + 2 * this.offset,
            }));
      }),
        (rn.prototype.updateConnectionOutline = function (e2, t2) {
          ...
          W(e2, {
            x: n2.x - this.offset,
            y: n2.y - this.offset,
            width: n2.width + 2 * this.offset,
            height: n2.height + 2 * this.offset,
          });
        }),
        (rn.prototype.registerProvider = function (e2, t2) {
          (t2 || ((t2 = e2), (e2 = 1e3)),
            this._eventBus.on("outline.getProviders", e2, function (e3) {
              e3.providers.push(t2);
            }));
        }),
        (rn.prototype._getProviders = function () {
          var e2 = this._eventBus.createEvent({
        ...
        (rn.prototype.getOutline = function (e2) {
          var t2;
          return (
            f(this._getProviders(), function (n2) {
      ...
      const an = { width: 36, height: 50 },
        sn = { width: 50, height: 50 };
      function ln(e2, t2, n2) {
        return q("path", {
          d: e2,
          strokeWidth: 2,
          transform: `translate(${t2.x}, ${t2.y})`,
          ...n2,
        });
      }
      function pn(e2, t2) {
      ...
      function cn(e2, t2) {
        var n2;
        return (
          "bpmn:DataObjectReference" === t2
            ? (n2 = an)
            : "bpmn:DataStoreReference" === t2 && (n2 = sn),
          e2.width === n2.width && e2.height === n2.height
        );
      }
      ((pn.$inject = ["outline", "styles"]),
        (pn.prototype.getOutline = function (e2) {
                ...
                : S(e2, [
                  ...
                  : R(e2, "bpmn:EndEvent")
                    ...
                    : R(e2, "bpmn:Event")
                      ...
                      : R(e2, "bpmn:DataObjectReference") &&
                          cn(e2, "bpmn:DataObjectReference")
                        ? (n2 = ln(
        ...
        (pn.prototype.updateOutline = function (e2, t2) {
          if (!O(e2))
            return S(e2, ["bpmn:SubProcess", "bpmn:Group"])
              ? (W(t2, { width: e2.width + 10, height: e2.height + 10 }), true)
              : !!S(e2, [
                  "bpmn:Event",
                  "bpmn:Gateway",
      ...
      function gn(e2, t2, n2) {
        ...
        function r2(n3, i3, r3) {
          ...
          (function (e3, t3) {
            ...
            (r3
              ? (a3 = t2.getGraphics(r3))
              : (o3 = i3.delegateTarget || i3.target) &&
                ((a3 = o3), (r3 = t2.get(a3))),
            a3 &&
              r3 &&
              false ===
                e2.fire(n3, { element: r3, gfx: a3, originalEvent: i3 }) &&
        ...
        var s2 = {
          ...
          l2 = {
            "element.contextmenu": dn,
            "element.mousedown": yn,
            "element.mouseup": yn,
            "element.click": yn,
            "element.dblclick": yn,
          };
        ...
        var h2 = y2("djs-hit djs-hit-stroke"),
          m2 = y2("djs-hit djs-hit-click-stroke"),
          d2 = {
            all: y2("djs-hit djs-hit-all"),
            "click-stroke": m2,
            stroke: h2,
            "no-move": y2("djs-hit djs-hit-no-move"),
          };
        function y2(e3, t3) {
          return (
            (t3 = E({ stroke: "white", strokeWidth: 15 }, t3 || {})),
            n2.cls(e3, ["no-fill", "no-border"], t3)
          );
        }
        function g2(e3, t3) {
          var n3 = d2[t3];
        ...
        ((this.removeHits = function (e3) {
          ...
          (this.createDefaultHit = function (e3, t3) {
            var n3,
              ...
              r3 = e3.isFrame;
            return i3
              ? this.createWaypointsHit(t3, i3)
              : ((n3 = r3 ? "stroke" : "all"),
                this.createBoxHit(t3, n3, {
                  width: e3.width,
                  height: e3.height,
                }));
          }),
          ...
          (this.updateDefaultHit = function (e3, t3) {
            ...
            if (n3)
              return (
                e3.waypoints
                  ? me(n3, e3.waypoints)
                  : W(n3, { width: e3.width, height: e3.height }),
                n3
              );
          }),
          (this.fire = r2),
          (this.triggerMouseEvent = function (e3, t3, n3) {
            var i3 = s2[e3];
            if (!i3) throw new Error("unmapped DOM event name <" + e3 + ">");
            return r2(i3, t3, n3);
          }),
          (this.mouseHandler = a2),
          (this.registerEvent = c2),
          (this.unregisterEvent = u2));
      }
      gn.$inject = ["eventBus", "elementRegistry", "styles"];
      var vn = {
        __init__: ["interactionEvents"],
        interactionEvents: ["type", gn],
      };
      function xn(e2, t2) {
        ((this._eventBus = e2),
          (this._canvas = t2),
      ...
      ((xn.$inject = ["eventBus", "canvas"]),
        (xn.prototype.deselect = function (e2) {
          var t2 = this._selectedElements,
            n2 = t2.indexOf(e2);
          if (-1 !== n2) {
            var i2 = t2.slice();
            (t2.splice(n2, 1),
        ...
        (xn.prototype.select = function (e2, t2) {
          var n2 = this._selectedElements,
            i2 = n2.slice();
          o(e2) || (e2 = e2 ? [e2] : []);
          var r2 = this._canvas,
            a2 = r2.getRootElement();
          ((e2 = e2.filter(function (e3) {
            ...
            t2
              ...
              : (this._selectedElements = n2 = e2.slice()),
            this._eventBus.fire("selection.changed", {
              oldSelection: i2,
              newSelection: n2,
            }));
      ...
      function _n(e2, t2, n2, i2) {
        (e2.on("create.end", 500, function (e3) {
          ...
          e2.on("shape.move.end", 500, function (e3) {
            var n3 = e3.previousSelection || [],
              r2 = i2.get(e3.context.shape.id);
            u(n3, function (e4) {
              return r2.id === e4.id;
            }) || t2.select(r2);
          }),
      ...
      ((En.$inject = ["canvas", "eventBus", "selection"]),
        (En.prototype._updateSelectionOutline = function (e2) {
          ...
          var n2 = e2.length > 1;
          if (
            (z(this._canvas.getContainer())[n2 ? "add" : "remove"](
              "djs-multi-select",
            ),
            n2)
          ) {
            var i2 = (function (e3) {
              ...
              r2 = q("rect");
            (W(r2, E({ rx: 3 }, i2)),
              z(r2).add("djs-selection-outline"),
              I(t2, r2));
          }
        }),
      ...
      var Rn = {
        ...
        __depends__: [vn, on],
        selection: ["type", xn],
        selectionVisuals: ["type", En],
        selectionBehavior: ["type", _n],
      };
      const Sn = /^class[ {]/;
      function kn(e2) {
      ...
      const Pn = /constructor\s*[^(]*\(\s*([^)]*)\)/m,
        On = /^(?:async\s+)?(?:function\s*[^(]*)?(?:\(\s*([^)]*)\)|(\w+))/m,
        Tn = /\/\*([^*]*)\*\//m;
      function Nn(e2) {
        if ("function" != typeof e2)
          throw new Error(`Cannot annotate "${e2}". Expected a function!`);
        const t2 = e2.toString().match(
          (function (e3) {
      ...
      function Dn(e2, t2) {
        const n2 = t2 || {
          ...
          i2 = [],
          r2 = (this._providers = Object.create(n2._providers || null)),
          o2 = (this._instances = /* @__PURE__ */ Object.create(null)),
          a2 = (o2.injector = this),
          s2 = function (e3) {
            const t3 = i2.join(" -> ");
            return (
              (i2.length = 0),
              new Error(t3 ? `${e3} (Resolving: ${t3})` : e3)
            );
          };
        function l2(e3, t3) {
          ...
          if (Cn(r2, e3)) {
            if (-1 !== i2.indexOf(e3))
              throw (i2.push(e3), s2("Cannot resolve circular dependency!"));
            return (
              i2.push(e3),
              (o2[e3] = r2[e3][0](r2[e3][1])),
              i2.pop(),
              o2[e3]
            );
          }
        ...
        function p2(e3, t3) {
          if ((void 0 === t3 && (t3 = {}), "function" != typeof e3)) {
            if (!kn(e3))
              throw s2(`Cannot invoke "${e3}". Expected a function!`);
            e3 = Mn(e3.slice());
          }
          return {
            fn: e3,
            dependencies: (e3.$inject || Nn(e3)).map((e4) =>
              Cn(t3, e4) ? t3[e4] : l2(e4),
            ),
          };
        }
        function c2(e3) {
              ...
              ((l3 = r2[e4]),
                -1 !== t3.indexOf(e4) &&
                  ("private" === l3[2]
                    ? ((p3 = o3.indexOf(l3[3])),
                      -1 === p3
                        ? ((c3 = l3[3].createChild([], t3)),
                          (u3 = h2(c3)),
                          o3.push(l3[3]),
                          a3.push(c3),
                          s3.push(u3),
                          (n3[e4] = [u3, e4, "private", c3]))
                        : (n3[e4] = [s3[p3], e4, "private", a3[p3]]))
                    : (n3[e4] = [l3[2], l3[1]]),
                  (i3[e4] = true)),
                ("factory" !== l3[2] && "type" !== l3[2]) ||
                  !l3[1].$scope ||
                  t3.forEach((t4) => {
                    -1 !== l3[1].$scope.indexOf(t4) &&
                      ((n3[e4] = [l3[2], l3[1]]), (i3[t4] = true));
                  }));
            (t3.forEach((e4) => {
              if (!i3[e4])
                throw new Error(
        ...
        function y2(e3) {
          ...
          if (t3) {
            const n3 = e3.__modules__,
              i3 = Object.keys(e3).reduce(
                (t4, n4) => (
                  "__exports__" !== n4 &&
                    "__modules__" !== n4 &&
                    "__init__" !== n4 &&
        ...
        function g2(e3, t3) {
          return -1 !== e3.indexOf(t3) ||
            -1 !== (e3 = (t3.__depends__ || []).reduce(g2, e3)).indexOf(t3)
            ? e3
            : e3.concat(t3);
        }
        ((this.get = l2),
      ...
      function Ln(e2, t2) {
        (A.call(this, e2, 1),
          (this.CONNECTION_STYLE = t2.style(["no-fill"], {
            strokeWidth: 5,
            stroke: "fuchsia",
          })),
          (this.SHAPE_STYLE = t2.style({
            fill: "white",
            stroke: "fuchsia",
            strokeWidth: 2,
          })),
          (this.FRAME_STYLE = t2.style(["no-fill"], {
            stroke: "fuchsia",
            strokeDasharray: 4,
            strokeWidth: 2,
          })));
      ...
      (e(Ln, A),
        (Ln.prototype.canRender = function () {
          return true;
        }),
        (Ln.prototype.drawShape = function (e2, t2, n2) {
          var i2 = q("rect");
          return (
            W(i2, { x: 0, y: 0, width: t2.width || 0, height: t2.height || 0 }),
            Pt(t2)
              ? W(i2, E({}, this.FRAME_STYLE, n2 || {}))
              : W(i2, E({}, this.SHAPE_STYLE, n2 || {})),
            I(e2, i2),
            i2
          );
        }),
        ...
        (Ln.prototype.getConnectionPath = function (e2) {
          var t2,
            ...
            i2 = e2.waypoints,
            r2 = [];
          for (t2 = 0; (n2 = i2[t2]); t2++)
            ((n2 = n2.original || n2),
              r2.push([0 === t2 ? "M" : "L", n2.x, n2.y]));
          return le(r2);
        }),
        (Ln.$inject = ["eventBus", "styles"]));
      var In = {
        __init__: ["defaultRenderer"],
        defaultRenderer: ["type", Ln],
        styles: [
          "type",
          function () {
            var e2 = {
      ...
      (($n.$inject = [
        ...
        ($n.prototype._init = function (e2) {
          const t2 = this._eventBus,
            n2 = (this._container = (function (e3) {
              const t3 =
                  (e3 = E({}, { width: "100%", height: "100%" }, e3))
                    .container || document.body,
                n3 = document.createElement("div");
              return (
                n3.setAttribute("class", "djs-container djs-parent"),
                Oe(n3, {
                  position: "relative",
                  overflow: "hidden",
                  width: Fn(e3.width),
          ...
          (e2.deferUpdate &&
            (this._viewboxChanged = (function (e3, t3) {
              let n3, i3, r3, o2;
              function a2(n4) {
                let a3 = Date.now(),
                  p3 = n4 ? 0 : o2 + t3 - a3;
            ...
            })(b(this._viewboxChanged, this), 300)),
            t2.on("diagram.init", () => {
            ...
            t2.on("diagram.destroy", 500, this._destroy, this),
            t2.on("diagram.clear", 500, this._clear, this));
        }),
        ($n.prototype._destroy = function () {
          ...
          (e2 && e2.removeChild(this._container),
            delete this._svg,
        ...
        ($n.prototype._clear = function () {
          (this._elementRegistry.getAll().forEach((e2) => {
            const t2 = Mt(e2);
            "root" === t2
              ? this.removeRootElement(e2)
              : this._removeElement(e2, t2);
          }),
            (this._planes = []),
            (this._rootElement = null),
            delete this._cachedViewbox);
        ...
        ($n.prototype.getLayer = function (e2, t2) {
          ...
          if (
            (n2 || (n2 = this._layers[e2] = this._createLayer(e2, t2)),
            void 0 !== t2 && n2.index !== t2)
          )
            throw new Error(
              "layer <" + e2 + "> already created at index <" + t2 + ">",
            );
          return n2.group;
        }),
        ...
        ($n.prototype._createLayer = function (e2, t2) {
          ...
          return {
            group: Vn(this._viewport, "layer-" + e2, n2),
            index: t2,
            visible: true,
          };
        }),
        ($n.prototype.showLayer = function (e2) {
          ...
          const n2 = this._viewport,
            i2 = t2.group,
            r2 = t2.index;
          if (t2.visible) return i2;
          const o2 = this._getChildIndex(r2);
          return (
            n2.insertBefore(i2, n2.childNodes[o2] || null),
            (t2.visible = true),
            i2
          );
        }),
        ...
        ($n.prototype.findRoot = function (e2) {
          if (
            ("string" == typeof e2 && (e2 = this._elementRegistry.get(e2)), !e2)
          )
            return;
          const t2 =
            this._findPlaneForRoot(
              (function (e3) {
        ...
        ($n.prototype._updateMarker = function (e2, t2, n2) {
          let i2;
          (e2.id || (e2 = this._elementRegistry.get(e2)),
            (e2.markers = e2.markers || /* @__PURE__ */ new Set()),
            (i2 = this._elementRegistry._elements[e2.id]),
            i2 &&
              (f([i2.gfx, i2.secondaryGfx], function (i3) {
                i3 &&
                  (n2
                    ? (e2.markers.add(t2), z(i3).add(t2))
                    : (e2.markers.delete(t2), z(i3).remove(t2)));
              }),
        ...
        ($n.prototype.hasMarker = function (e2, t2) {
          return (
            e2.id || (e2 = this._elementRegistry.get(e2)),
            !!e2.markers && e2.markers.has(t2)
          );
        }),
        ($n.prototype.toggleMarker = function (e2, t2) {
          this.hasMarker(e2, t2)
            ? this.removeMarker(e2, t2)
            : this.addMarker(e2, t2);
        }),
        ($n.prototype.getRootElement = function () {
          const e2 = this._rootElement;
          return e2 || this._planes.length
            ? e2
        ...
        ($n.prototype.addRootElement = function (e2) {
          ...
          return (
            this.hideLayer(n2),
            this._addRoot(e2, i2),
            this._planes.push({ rootElement: e2, layer: i2 }),
            e2
          );
        }),
        ($n.prototype.removeRootElement = function (e2) {
          "string" == typeof e2 && (e2 = this._elementRegistry.get(e2));
          if (this._findPlaneForRoot(e2))
            return (
              this._removeRoot(e2),
              this._removeLayer(e2.layer),
              (this._planes = this._planes.filter(function (t2) {
                return t2.rootElement !== e2;
              })),
              this._rootElement === e2 && (this._rootElement = null),
              e2
            );
        }),
        ($n.prototype.setRootElement = function (e2) {
          ...
          return (
            (t2 = this._findPlaneForRoot(e2)),
            t2 || (e2 = this.addRootElement(e2)),
            this._setRoot(e2),
            e2
          );
        }),
        ($n.prototype._removeRoot = function (e2) {
          const t2 = this._elementRegistry,
            n2 = this._eventBus;
          (n2.fire("root.remove", { element: e2 }),
            n2.fire("root.removed", { element: e2 }),
            t2.remove(e2));
        }),
        ($n.prototype._addRoot = function (e2, t2) {
          const n2 = this._elementRegistry,
            i2 = this._eventBus;
          (i2.fire("root.add", { element: e2 }),
            n2.add(e2, t2),
            i2.fire("root.added", { element: e2, gfx: t2 }));
        }),
        ($n.prototype._setRoot = function (e2, t2) {
          const n2 = this._rootElement;
          (n2 &&
            (this._elementRegistry.updateGraphics(n2, null, true),
            this.hideLayer(n2.layer)),
            e2 &&
              (t2 || (t2 = this._findPlaneForRoot(e2).layer),
              this._elementRegistry.updateGraphics(e2, this._svg, true),
              this.showLayer(e2.layer)),
            (this._rootElement = e2),
            this._eventBus.fire("root.set", { element: e2 }));
        }),
        ($n.prototype._ensureValid = function (e2, t2) {
          if (!t2.id) throw new Error("element must have an id");
          if (this._elementRegistry.get(t2.id))
            throw new Error("element <" + t2.id + "> already exists");
          const n2 = Wn[e2],
            i2 = d(n2, function (e3) {
              return void 0 !== t2[e3];
            });
          if (!i2)
            throw new Error("must supply { " + n2.join(", ") + " } with " + e2);
        }),
        ...
        ($n.prototype._addElement = function (e2, t2, n2, i2) {
          ...
          const r2 = this._eventBus,
            o2 = this._graphicsFactory;
          (this._ensureValid(e2, t2),
            r2.fire(e2 + ".add", { element: t2, parent: n2 }),
            this._setParent(t2, n2, i2));
          const a2 = o2.create(e2, t2, i2);
          return (
            this._elementRegistry.add(t2, a2),
            o2.update(e2, t2, a2),
            r2.fire(e2 + ".added", { element: t2, gfx: a2 }),
            t2
          );
        }),
        ...
        ($n.prototype._removeElement = function (e2, t2) {
          const n2 = this._elementRegistry,
            i2 = this._graphicsFactory,
            r2 = this._eventBus;
          if ((e2 = n2.get(e2.id || e2)))
            return (
              r2.fire(t2 + ".remove", { element: e2 }),
              i2.remove(e2),
              (function (e3, t3) {
                if (!e3 || !t3) return -1;
                var n3 = e3.indexOf(t3);
                -1 !== n3 && e3.splice(n3, 1);
              })(e2.parent && e2.parent.children, e2),
              (e2.parent = null),
              r2.fire(t2 + ".removed", { element: e2 }),
              n2.remove(e2),
              e2
            );
        }),
        ...
        ($n.prototype.viewbox = function (e2) {
          ...
          return e2
            ? (this._changeViewbox(function () {
              ...
              e2)
            : ((o2 = this._rootElement ? this.getActiveLayer() : null),
              (i2 = (o2 && o2.getBBox()) || {}),
              (a2 = se(t2)),
              (r2 = a2
                ? a2.matrix
                : (function (e3, t3, n3, i3, r3, o3) {
        ...
        ($n.prototype.scrollToElement = function (e2, t2) {
          ...
          if (
            (i2 !== this.getRootElement() && this.setRootElement(i2), i2 === e2)
          )
            return;
          (t2 || (t2 = {}),
            "number" == typeof t2 && (n2 = t2),
            (t2 = {
              top: t2.top || n2,
              right: t2.right || n2,
              bottom: t2.bottom || n2,
          ...
          ((a2.y += t2.top / s2),
            (a2.x += t2.left / s2),
            (a2.width -= (t2.right + t2.left) / s2),
            (a2.height -= (t2.bottom + t2.top) / s2));
          const c2 = vt(a2);
          if (r2.width < a2.width && r2.height < a2.height) {
            const e3 = Math.max(0, o2.right - c2.right),
              t3 = Math.min(0, o2.left - c2.left),
              n3 = Math.max(0, o2.bottom - c2.bottom),
              i3 = Math.min(0, o2.top - c2.top);
            ((l2 = e3 || t3), (p2 = n3 || i3));
        ...
        ($n.prototype.zoom = function (e2, t2) {
          ...
          return (
            this._changeViewbox(function () {
              ("object" != typeof t2 &&
                ((n2 = this.viewbox().outer),
                (t2 = { x: n2.width / 2, y: n2.height / 2 })),
                (i2 = this._setZoom(e2, t2)));
            }),
            jn(i2.a, 1e3)
          );
        }),
        ($n.prototype._fitViewport = function (e2) {
          ...
          return (
            i2.x >= 0 &&
            i2.y >= 0 &&
            i2.x + i2.width <= n2.width &&
            i2.y + i2.height <= n2.height &&
            !e2
              ? (o2 = {
                  x: 0,
                  y: 0,
                  width: Math.max(i2.width + i2.x, n2.width),
                  height: Math.max(i2.height + i2.y, n2.height),
                })
              : ((r2 = Math.min(1, n2.width / i2.width, n2.height / i2.height)),
                (o2 = {
                  x: i2.x + (e2 ? i2.width / 2 - n2.width / r2 / 2 : 0),
                  y: i2.y + (e2 ? i2.height / 2 - n2.height / r2 / 2 : 0),
                  width: n2.width / r2,
                  height: n2.height / r2,
                })),
            this.viewbox(o2),
            this.viewbox(false).scale
          );
        }),
        ($n.prototype._setZoom = function (e2, t2) {
          const n2 = this._svg,
            i2 = this._viewport,
            r2 = n2.createSVGMatrix(),
            o2 = n2.createSVGPoint();
          let a2, s2, l2, p2, c2;
          l2 = i2.getCTM();
          const u2 = l2.a;
          return (
            t2
              ? ((a2 = E(o2, t2)),
                (s2 = a2.matrixTransform(l2.inverse())),
                (p2 = r2
                  .translate(s2.x, s2.y)
                  .scale((1 / u2) * e2)
                  .translate(-s2.x, -s2.y)),
        ...
        ($n.prototype.getAbsoluteBBox = function (e2) {
          ...
          return {
            x: n2.x * t2.scale - t2.x * t2.scale,
            y: n2.y * t2.scale - t2.y * t2.scale,
            width: n2.width * t2.scale,
            height: n2.height * t2.scale,
          };
        }),
      ...
      function Kn(e2, t2, n2) {
        var i2 = (function (e3, t3, n3, i3) {
          var r2 = n3.inverse;
          return (
            Object.defineProperty(e3, "remove", {
              value: function (e4) {
                var n4 = this.indexOf(e4);
                return (
                  -1 !== n4 && (this.splice(n4, 1), t3.unset(e4, r2, i3)),
                  e4
                );
              },
            }),
            Object.defineProperty(e3, "contains", {
              value: function (e4) {
                return -1 !== this.indexOf(e4);
              },
            }),
            Object.defineProperty(e3, "add", {
              value: function (e4, n4) {
                var o2 = this.indexOf(e4);
                if (void 0 === n4) {
                  if (-1 !== o2) return;
                  n4 = this.length;
                }
                (-1 !== o2 && this.splice(o2, 1),
                  this.splice(n4, 0, e4),
                  -1 === o2 && t3.set(e4, r2, i3));
              },
            }),
            Object.defineProperty(e3, "__refs_collection", { value: true }),
            e3
          );
        })(n2[t2.name] || [], e2, t2, n2);
        (Object.defineProperty(n2, t2.name, {
          enumerable: t2.enumerable,
          value: i2,
        }),
          i2.length &&
      ...
      function Un(e2, t2) {
        ...
        ((e2.inverse = t2),
          (t2.inverse = e2),
          (this.props = {}),
          (this.props[e2.name] = e2),
          (this.props[t2.name] = t2));
      }
      ((Hn.$inject = ["eventBus"]),
        (Hn.prototype.add = function (e2, t2, n2) {
          var i2 = e2.id;
          (this._validateId(i2),
            W(t2, Gn, i2),
            n2 && W(n2, Gn, i2),
            (this._elements[i2] = { element: e2, gfx: t2, secondaryGfx: n2 }));
        }),
        (Hn.prototype.remove = function (e2) {
          ...
          i2 &&
            (W(i2.gfx, Gn, ""),
            i2.secondaryGfx && W(i2.secondaryGfx, Gn, ""),
            delete t2[n2]);
        }),
        (Hn.prototype.updateId = function (e2, t2) {
          (this._validateId(t2),
            "string" == typeof e2 && (e2 = this.get(e2)),
            this._eventBus.fire("element.updateId", {
              element: e2,
              newId: t2,
            }));
          var n2 = this.getGraphics(e2),
            i2 = this.getGraphics(e2, true);
          (this.remove(e2), (e2.id = t2), this.add(e2, n2, i2));
        }),
        (Hn.prototype.updateGraphics = function (e2, t2, n2) {
          var i2 = e2.id || e2,
            r2 = this._elements[i2];
          return (
            n2 ? (r2.secondaryGfx = t2) : (r2.gfx = t2),
            t2 && W(t2, Gn, i2),
            t2
          );
        }),
        ...
        (Hn.prototype.find = function (e2) {
          for (
            var t2 = this._elements, n2 = Object.keys(t2), i2 = 0;
            i2 < n2.length;
            i2++
          ) {
            var r2 = t2[n2[i2]],
        ...
        (Un.prototype.bind = function (e2, t2) {
          ...
          t2.collection
            ...
            : (function (e3, t3, n2) {
                var i2 = t3.inverse,
                  r2 = n2[t3.name];
                Object.defineProperty(n2, t3.name, {
                  configurable: t3.configurable,
                  enumerable: t3.enumerable,
                  get: function () {
                    return r2;
                  },
                  set: function (t4) {
        ...
        (Un.prototype.unset = function (e2, t2, n2) {
          e2 &&
            (this.ensureBound(e2, t2),
            t2.collection
              ? this.ensureRefsCollection(e2, t2).remove(n2)
              : (e2[t2.name] = void 0));
        }),
        (Un.prototype.set = function (e2, t2, n2) {
          e2 &&
            (this.ensureBound(e2, t2),
            t2.collection
              ? this.ensureRefsCollection(e2, t2).add(n2)
              : (e2[t2.name] = n2));
        }));
      var qn = new Un(
        ...
        Xn = new Un({ name: "attachers", collection: true }, { name: "host" }),
        Zn = new Un({ name: "outgoing", collection: true }, { name: "source" }),
        Jn = new Un({ name: "incoming", collection: true }, { name: "target" });
      function Qn() {
        (Object.defineProperty(this, "businessObject", { writable: true }),
          ...
          qn.bind(this, "parent"),
          Yn.bind(this, "labels"),
          Zn.bind(this, "outgoing"),
          Jn.bind(this, "incoming"));
      }
      function ei() {
        (Qn.call(this),
          qn.bind(this, "children"),
          Xn.bind(this, "host"),
          Xn.bind(this, "attachers"));
      }
      function ti() {
      ...
      ((oi.prototype.createRoot = function (e2) {
        ...
        (oi.prototype.create = function (e2, t2) {
          return (
            (t2 = E({}, t2 || {})).id || (t2.id = e2 + "_" + this._uid++),
            (function (e3, t3) {
              var n2 = ri[e3];
      ...
      ((li.prototype.on = function (e2, t2, n2, i2) {
        ...
        (li.prototype.once = function (e2, t2, n2, i2) {
          var r2 = this;
          if ((l(t2) && ((i2 = n2), (n2 = t2), (t2 = 1e3)), !s(t2)))
            throw new Error("priority must be a number");
          function o2() {
            o2.__isTomb = true;
        ...
        (li.prototype.fire = function (e2, t2) {
          var n2, i2, r2, o2;
          if (
            ((o2 = si.call(arguments)),
            "object" == typeof e2 && (e2 = (t2 = e2).type),
            !e2)
          )
        ...
        (li.prototype._invokeListeners = function (e2, t2, n2) {
          for (var i2; n2 && !e2.cancelBubble; )
            ((i2 = this._invokeListener(e2, t2, n2)), (n2 = n2.next));
          return i2;
        }),
        (li.prototype._invokeListener = function (e2, t2, n2) {
          ...
          try {
            ((i2 = (function (e3, t3) {
              ...
              void 0 !== i2 && ((e2.returnValue = i2), e2.stopPropagation()),
              false === i2 && e2.preventDefault());
          } catch (e3) {
            if (!this.handleError(e3))
              throw (
                console.error("unhandled error in event listener", e3),
                e3
              );
          }
          return i2;
        ...
        (li.prototype._addListener = function (e2, t2) {
          var n2,
            i2 = this._getListeners(e2);
          if (i2) {
            for (; i2; ) {
              if (i2.priority < t2.priority)
                return (
                  (t2.next = i2),
                  void (n2 ? (n2.next = t2) : this._setListeners(e2, t2))
                );
              ((n2 = i2), (i2 = i2.next));
            }
            n2.next = t2;
        ...
        (li.prototype._removeListener = function (e2, t2) {
          var n2,
            i2,
            r2,
            o2 = this._getListeners(e2);
          if (t2)
            for (; o2; )
              ((n2 = o2.next),
                ((r2 = o2.callback) !== t2 && r2[ai] !== t2) ||
                  (i2 ? (i2.next = n2) : this._setListeners(e2, n2)),
                (i2 = o2),
                (o2 = n2));
        ...
        (ci.$inject = ["eventBus", "elementRegistry"]),
        (ci.prototype._getChildrenContainer = function (e2) {
          var t2,
            n2 = this._elementRegistry.getGraphics(e2);
          return (
            e2.parent
              ? ((t2 = (function (e3) {
                ...
                t2 ||
                  (z((t2 = q("g"))).add("djs-children"), I(n2.parentNode, t2)))
              : (t2 = n2),
            t2
          );
        }),
        ...
        (ci.prototype._createContainer = function (e2, t2, n2, i2) {
          var r2 = q("g");
          (z(r2).add("djs-group"),
            void 0 !== n2 ? ui(r2, t2, t2.childNodes[n2]) : I(t2, r2));
          var o2 = q("g");
          (z(o2).add("djs-element"),
            z(o2).add("djs-" + e2),
            i2 && z(o2).add("djs-frame"),
            I(r2, o2));
          var a2 = q("g");
      ...
      var hi = {
        ...
        __init__: ["canvas"],
        canvas: ["type", $n],
        elementRegistry: ["type", Hn],
        elementFactory: ["type", oi],
        eventBus: ["type", li],
        graphicsFactory: ["type", ci],
      };
      function fi(e2) {
        return (function (e3) {
          var t2 = new Dn(e3);
      ...
      ((mi.prototype.get = function (e2, t2) {
        ...
        (yi.prototype.createType = function (e2) {
          var t2 = this.model,
            n2 = this.properties,
            i2 = Object.create(di.prototype);
          (f(e2.properties, function (e3) {
            e3.isMany || void 0 === e3.default || (i2[e3.name] = e3.default);
          }),
            n2.defineModel(i2, t2),
            n2.defineDescriptor(i2, e2));
          var r2 = e2.ns.name;
          function o2(e3) {
            (n2.define(this, "$type", { value: r2, enumerable: true }),
              n2.define(this, "$attrs", { value: {} }),
              n2.define(this, "$parent", { writable: true }),
              f(
                e3,
                b(function (e4, t3) {
                  this.set(t3, e4);
          ...
          return (
            (o2.prototype = i2),
            (o2.hasType = i2.$instanceOf = this.model.hasType),
            n2.defineModel(o2, t2),
            n2.defineDescriptor(o2, e2),
            o2
          );
        }));
      var gi = {
      ...
      function Ei(e2, t2) {
        ...
        if (1 === r2.length) ((n2 = e2), (i2 = t2));
          ...
          if (2 !== r2.length)
            throw new Error(
              "expected <prefix:localName> or <localName>, got " + e2,
            );
          ((n2 = r2[1]), (i2 = r2[0]));
        }
        return {
      ...
      function Ai(e2, t2) {
        ((this.packageMap = {}),
          ...
          (this.packages = []),
          (this.properties = t2),
          f(e2, b(this.registerPackage, this)));
      }
      function Ri(e2, t2, n2) {
        var i2 = t2[n2];
        if (i2 in e2)
          throw new Error(
            "package with " + n2 + " <" + i2 + "> already defined",
          );
      }
      function Si(e2) {
        this.model = e2;
      ...
      function ki(e2, t2, n2) {
        Object.defineProperty(e2, t2.name, {
          enumerable: !t2.isReference,
          writable: true,
          value: n2,
          configurable: true,
        });
      ...
      function Mi(e2, t2 = {}) {
        ((this.properties = new Si(this)),
          (this.factory = new yi(this, this.properties)),
          (this.registry = new Ai(e2, this.properties)),
          (this.typeCache = {}),
          (this.config = t2));
      }
      ((_i.prototype.build = function () {
        ...
        (_i.prototype.addProperty = function (e2, t2, n2) {
          ("boolean" == typeof t2 && ((n2 = t2), (t2 = void 0)),
            this.addNamedProperty(e2, false !== n2));
        ...
        (_i.prototype.replaceProperty = function (e2, t2, n2) {
          ...
          if (-1 === s2)
            throw new Error(
              "property <" + i2.name + "> not found in property list",
            );
          (r2.splice(s2, 1),
            this.addProperty(t2, n2 ? void 0 : s2, a2),
            (o2[i2.name] = o2[i2.localName] = t2));
        }),
        (_i.prototype.redefineProperty = function (e2, t2, n2) {
          var i2 = e2.ns.prefix,
            r2 = t2.split("#"),
            o2 = Ei(r2[0], i2),
            a2 = Ei(r2[1], o2.prefix).name,
            s2 = this.propertiesByName[a2];
        ...
        (_i.prototype.addNamedProperty = function (e2, t2) {
          var n2 = e2.ns,
            i2 = this.propertiesByName;
          (t2 &&
            (this.assertNotDefined(e2, n2.name),
            this.assertNotDefined(e2, n2.localName)),
            (i2[n2.name] = i2[n2.localName] = e2));
        }),
        (_i.prototype.removeNamedProperty = function (e2) {
          var t2 = e2.ns,
            n2 = this.propertiesByName;
          (delete n2[t2.name], delete n2[t2.localName]);
        }),
        (_i.prototype.setBodyProperty = function (e2, t2) {
          if (t2 && this.bodyProperty)
            throw new Error(
        ...
        (_i.prototype.assertNotTrait = function (e2) {
          if ((e2.extends || []).length)
            throw new Error(
              `cannot create <${e2.name}> extending <${e2.extends}>`,
            );
        }),
        (_i.prototype.assertNotDefined = function (e2, t2) {
          var n2 = e2.name,
            i2 = this.propertiesByName[n2];
          if (i2)
            throw new Error(
              "property <" +
                n2 +
                "> already defined; override of <" +
                i2.definedBy.ns.name +
                "#" +
                i2.ns.name +
                "> by <" +
                e2.definedBy.ns.name +
                "#" +
                e2.ns.name +
        ...
        (_i.prototype.addTrait = function (e2, t2) {
          ...
          r2 in n2 ||
            (f(
              e2.properties,
              b(function (n3) {
                ((n3 = E({}, n3, { name: n3.ns.localName, inherited: t2 })),
                  Object.defineProperty(n3, "definedBy", { value: e2 }));
                var i3 = n3.replaces,
                  r3 = n3.redefines;
                i3 || r3
                  ? this.redefineProperty(n3, i3 || r3, i3)
                  : (n3.isBody && this.setBodyProperty(n3),
                    n3.isId && this.setIdProperty(n3),
                    this.addProperty(n3));
              }, this),
            ),
            i2.push(e2),
        ...
        (Ai.prototype.registerPackage = function (e2) {
          ...
          (Ri(t2, e2, "prefix"),
            ...
            (t2[e2.uri] = t2[e2.prefix] = e2),
            this.packages.push(e2));
        }),
        (Ai.prototype.registerType = function (e2, t2) {
          var n2 = Ei(
              (e2 = E({}, e2, {
                superClass: (e2.superClass || []).slice(),
                extends: (e2.extends || []).slice(),
                properties: (e2.properties || []).slice(),
                meta: E(e2.meta || {}),
              })).name,
              t2.prefix,
            ),
          ...
          (f(
            e2.properties,
            b(function (e3) {
              var t3 = Ei(e3.name, n2.prefix),
                i3 = t3.name;
              (wi(e3.type) || (e3.type = Ei(e3.type, t3.prefix).name),
                E(e3, { ns: t3, name: i3 }),
                (r2[i3] = e3));
            }, this),
          ),
            E(e2, { ns: n2, name: i2, propertiesByName: r2 }),
            f(
              e2.extends,
              b(function (e3) {
                var t3 = Ei(e3, n2.prefix),
                  r3 = this.typeMap[t3.name];
                ((r3.traits = r3.traits || []), r3.traits.push(i2));
              }, this),
            ),
            this.definePackage(e2, t2),
            (this.typeMap[i2] = e2));
        }),
        (Ai.prototype.mapTypes = function (e2, t2, n2) {
          var i2 = wi(e2.name) ? { name: e2.name } : this.typeMap[e2.name],
            r2 = this;
          function o2(n3, i3) {
        ...
        (Ai.prototype.getEffectiveDescriptor = function (e2) {
          ...
          var i2 = n2.build();
          return (
            this.definePackage(i2, i2.allTypes[i2.allTypes.length - 1].$pkg),
            i2
          );
        }),
        ...
        (Si.prototype.set = function (e2, t2, n2) {
          ...
          var i2 = this.getProperty(e2, t2),
            r2 = i2 && i2.name;
          void 0 === n2
            ? i2
              ? delete e2[r2]
              : delete e2.$attrs[Ci(t2)]
            : i2
              ? r2 in e2
                ? (e2[r2] = n2)
                : ki(e2, i2, n2)
        ...
        (Si.prototype.getProperty = function (e2, t2) {
          var n2 = this.model,
            i2 = n2.getPropertyDescriptor(e2, t2);
          if (i2) return i2;
          if (t2.includes(":")) return null;
          const r2 = n2.config.strict;
          if (void 0 !== r2) {
            const n3 = new TypeError(
              `unknown property <${t2}> on <${e2.$type}>`,
            );
            if (r2) throw n3;
        ...
        (Mi.prototype.getType = function (e2) {
          var t2 = this.typeCache,
            n2 = p(e2) ? e2 : e2.ns.name,
            i2 = t2[n2];
          return (
            i2 ||
              ((e2 = this.registry.getEffectiveDescriptor(n2)),
              (i2 = t2[n2] = this.factory.createType(e2))),
            i2
          );
        }),
        (Mi.prototype.createAny = function (e2, t2, n2) {
          var o2 = Ei(e2),
            ...
            l2 = {
              name: e2,
              isGeneric: true,
              ns: { prefix: o2.prefix, localName: o2.localName, uri: t2 },
            };
          return (
            this.properties.defineDescriptor(s2, l2),
            this.properties.defineModel(s2, this),
            this.properties.define(s2, "get", {
              enumerable: false,
              writable: true,
            }),
            this.properties.define(s2, "set", {
              enumerable: false,
              writable: true,
            }),
            this.properties.define(s2, "$parent", {
              enumerable: false,
              writable: true,
            }),
            this.properties.define(s2, "$instanceOf", {
              enumerable: false,
              writable: true,
            }),
            f(n2, function (e3, t3) {
              a(e3) && void 0 !== e3.value
                ? (s2[e3.name] = e3.value)
                : (s2[t3] = e3);
            }),
            s2
        ...
        (Mi.prototype.hasType = function (e2, t2) {
          return (
            void 0 === t2 && ((t2 = e2), (e2 = this)),
            t2 in e2.$model.getElementDescriptor(e2).allTypesByName
          );
        }),
      ...
      var Pi = String.fromCharCode,
        ...
        Ti = /&#(\d+);|&#x([0-9a-f]+);|&(\w+);/gi,
        Ni = { amp: "&", apos: "'", gt: ">", lt: "<", quot: '"' };
      function Di(e2, t2, n2, i2) {
        return i2
          ? Oi.call(Ni, i2)
            ? Ni[i2]
            : "&" + i2 + ";"
          : Pi(t2 || parseInt(n2, 16));
      }
      function Bi(e2) {
        return e2.length > 3 && -1 !== e2.indexOf("&")
          ? e2.replace(Ti, Di)
          : e2;
      }
      ...
      var Li = "xsi:type",
        Ii = "non-whitespace outside of root node";
      function ji(e2) {
        return new Error(e2);
      }
      function Fi(e2) {
      ...
      function Hi(e2) {
        ...
        ((this.on = function (e3, p3) {
          ...
          (this.ns = function (e3) {
            if ((void 0 === e3 && (e3 = {}), "object" != typeof e3))
              throw ji("required args <nsMap={}>");
            var t3,
              n3 = {};
            for (t3 in e3) n3[t3] = e3[t3];
            return (
              (n3["http://www.w3.org/2001/XMLSchema-instance"] = "xsi"),
              (m2 = true),
              (p2 = n3),
              this
            );
              ...
              (function (e4) {
                ...
                function I2() {
                  ...
                  e: for (; y3 < x3; y3++)
                    if (
                      ((l3 = false),
                      !(32 === (c3 = g3.charCodeAt(y3)) || (c3 < 14 && c3 > 8)))
                    ) {
                      for (
                        (c3 < 65 || c3 > 122 || (c3 > 90 && c3 < 97)) &&
                          95 !== c3 &&
                          58 !== c3 &&
                          (v2("illegal first char attribute name"),
                          (l3 = true)),
                          u4 = y3 + 1;
                        u4 < x3;
                        u4++
                      ...
                      if (
                        ("xmlns:xmlns" === (s3 = g3.substring(y3, u4)) &&
                          (v2("illegal declaration of xmlns"), (l3 = true)),
                        34 === (c3 = g3.charCodeAt(u4 + 1)))
                      )
                        -1 === (u4 = g3.indexOf('"', (y3 = u4 + 2))) &&
                          -1 !== (u4 = g3.indexOf("'", y3)) &&
                          (v2("attribute value quote missmatch"), (l3 = true));
                      else if (39 === c3)
                        -1 === (u4 = g3.indexOf("'", (y3 = u4 + 2))) &&
                          -1 !== (u4 = g3.indexOf('"', y3)) &&
                          (v2("attribute value quote missmatch"), (l3 = true));
                        ...
                        for (
                          v2("missing attribute value quotes"),
                            l3 = true,
                            u4 += 1;
                          u4 < x3 &&
                          !(
                            32 === (c3 = g3.charCodeAt(u4 + 1)) ||
                            (c3 < 14 && c3 > 8)
                          );
                          u4++
                        );
                      for (
                        -1 === u4 &&
                          (v2("missing closing quotes"),
                          (u4 = x3),
                          (l3 = true)),
                          l3 || (o4 = g3.substring(y3, u4)),
                          y3 = u4;
                        u4 + 1 < x3 &&
                        !(
                          32 === (c3 = g3.charCodeAt(u4 + 1)) ||
                        ...
                        y3 === u4 &&
                          (v2("illegal character after attribute end"),
                          (l3 = true));
                      if (((y3 = u4 + 1), !l3))
                        if (s3 in b3)
                          v2("attribute <" + s3 + "> already defined");
                        else if (((b3[s3] = true), m2))
                          if (f2) {
                            if (
                              null !==
                              (r3 =
                            ...
                            -1 !== (c3 = s3.indexOf(":"))
                              ? (n3 = C2[s3.substring(0, c3)])
                                ? ((s3 =
                                    h3 === n3
                                      ? s3.substr(c3 + 1)
                                      : n3 + s3.substr(c3)) === Li &&
                                    (-1 !== (c3 = o4.indexOf(":"))
                                      ? ((n3 = o4.substring(0, c3)),
                                        (o4 =
                                          (n3 = C2[n3] || n3) +
                                          o4.substring(c3)))
                                      : (o4 = h3 + ":" + o4)),
                  ...
                  if (f2)
                    for (y3 = 0, x3 = d4.length; y3 < x3; y3++) {
                      if (
                        ((s3 = d4[y3++]),
                        (o4 = d4[y3]),
                        -1 !== (c3 = s3.indexOf(":")))
                        ...
                        (s3 =
                          ...
                          (-1 !== (c3 = o4.indexOf(":"))
                            ? ((n3 = o4.substring(0, c3)),
                              (o4 = (n3 = C2[n3] || n3) + o4.substring(c3)))
                            : (o4 = h3 + ":" + o4));
                      }
                      w3[s3] = o4;
                    }
                ...
                function j2() {
                  for (
                    ...
                    N2 >= a3 &&
                    (t3 = i3.exec(e4)) &&
                    !((s3 = t3[0].length + t3.index) > N2);

                  )
                    ((r3 += 1), (a3 = s3));
                  return (
                    -1 == N2
                      ? ((o4 = s3), (n3 = e4.substring(D2)))
                      : 0 === D2
                        ? (n3 = e4.substring(D2, N2))
                        : ((o4 = N2 - a3),
                          (n3 =
                            -1 == D2
                              ? e4.substring(N2)
                              : e4.substring(N2, D2 + 1))),
                    { data: n3, line: r3, column: o4 }
                  );
                }
                ((h2 = j2),
                  c2 &&
                ...
                for (; -1 !== D2; ) {
                  if (
                    -1 ===
                    (N2 = 60 === e4.charCodeAt(D2) ? D2 : e4.indexOf("<", D2))
                  )
                    return M2.length
                      ? g2("unexpected end of file")
                      : 0 === D2
                        ? g2("missing start tag")
                        : void (
                            D2 < e4.length &&
                            e4.substring(D2).trim() &&
                            v2(Ii)
                          );
                  if (D2 !== N2) {
                    if (M2.length) {
                      if (t2 && (t2(e4.substring(D2, N2), Bi, h2), y2)) return;
                    } else if (e4.substring(D2, N2).trim() && (v2(Ii), y2))
                      return;
                  }
                  if (33 === (w2 = e4.charCodeAt(N2 + 1))) {
                    if (
                      91 === (x2 = e4.charCodeAt(N2 + 2)) &&
                      "CDATA[" === e4.substr(N2 + 3, 6)
                    ) {
                      if (-1 === (D2 = e4.indexOf("]]>", N2)))
                        return g2("unclosed cdata");
                    ...
                    if (45 === x2 && 45 === e4.charCodeAt(N2 + 3)) {
                      if (-1 === (D2 = e4.indexOf("-->", N2)))
                        return g2("unclosed comment");
                      if (a2 && (a2(e4.substring(N2 + 4, D2), Bi, h2), y2))
                        return;
                      D2 += 3;
                      continue;
                    }
                  ...
                  if (63 !== w2) {
                    for (u3 = N2 + 1; ; u3++) {
                      if (((b2 = e4.charCodeAt(u3)), isNaN(b2)))
                        return ((D2 = -1), g2("unclosed tag"));
                      if (34 === b2)
                        u3 = -1 !== (x2 = e4.indexOf('"', u3 + 1)) ? x2 : u3;
                      else if (39 === b2)
                        u3 = -1 !== (x2 = e4.indexOf("'", u3 + 1)) ? x2 : u3;
                      else if (62 === b2) {
                        D2 = u3;
                    ...
                    if (33 !== w2) {
                      if (((S2 = {}), 47 === w2)) {
                        if (((O2 = false), (T2 = true), !M2.length))
                          return g2("missing open tag");
                        if (
                          ((u3 = _2 = M2.pop()),
                          (x2 = N2 + 2 + u3.length),
                          e4.substring(N2 + 2, x2) !== u3)
                        )
                          return g2("closing tag mismatch");
                        for (; x2 < D2; x2++)
                          if (
                            !(
                              32 === (w2 = e4.charCodeAt(x2)) ||
                              (w2 > 8 && w2 < 14)
                            )
                          )
                            return g2("close tag");
                        ...
                        if (
                          (47 === e4.charCodeAt(D2 - 1)
                            ? ((u3 = _2 = e4.substring(N2 + 1, D2 - 1)),
                              (O2 = true),
                              (T2 = true))
                            : ((u3 = _2 = e4.substring(N2 + 1, D2)),
                              (O2 = true),
                              (T2 = false)),
                          !(
                            (w2 > 96 && w2 < 123) ||
                          ...
                          return g2("illegal first char nodeName");
                        for (x2 = 1, d3 = u3.length; x2 < d3; x2++)
                          if (
                            !(
                              ((w2 = u3.charCodeAt(x2)) > 96 && w2 < 123) ||
                              (w2 > 64 && w2 < 91) ||
                              (w2 > 47 && w2 < 59) ||
                              45 === w2 ||
                              95 === w2 ||
                      ...
                      if (m2) {
                        if (
                          ...
                          O2 &&
                            (T2 || k2.push(o3),
                            null === S2 &&
                              (f2 = -1 !== u3.indexOf("xmlns", x2)) &&
                              ((L2 = x2), (B2 = u3), I2(), (f2 = false))),
                          (A2 = _2),
                          -1 !== (w2 = _2.indexOf(":")))
                        ) {
                          if (!(E2 = C2[_2.substring(0, w2)]))
                            return g2("missing namespace on <" + A2 + ">");
                          _2 = _2.substr(w2 + 1);
                        } else E2 = C2.xmlns;
                        E2 && (_2 = E2 + ":" + _2);
                      }
                      if (
                        ...
                        (B2 = u3),
                        n2 &&
                          (c2 ? n2(R2, Bi, T2, h2) : n2(_2, I2, Bi, T2, h2),
                          y2))
                      )
                        return;
                      if (T2) {
                      ...
                      if (l2 && (l2(e4.substring(N2, D2 + 1), Bi, h2), y2))
                        return;
                      D2 += 1;
                    }
                  } else {
                    if (-1 === (D2 = e4.indexOf("?>", N2)))
                      return g2("unclosed question");
      ...
      function Zi(e2, t2) {
        return Ki(t2)
          ? e2.prefix +
              ":" +
              ((n2 = e2.localName).charAt(0).toUpperCase() + n2.slice(1))
          : e2.name;
        var n2;
      }
      function Ji(e2) {
      ...
      ((tr.prototype.handleEnd = function () {}),
        ...
        (nr.prototype.handleNode = function () {
          return this;
        }),
        (ir.prototype = Object.create(tr.prototype)),
        (ir.prototype.handleText = function (e2) {
          this.body = (this.body || "") + e2;
        }),
        (rr.prototype = Object.create(ir.prototype)),
        (rr.prototype.handleNode = function (e2) {
        ...
        (or.prototype.handleEnd = function () {
          var e2 = this.body || "",
            t2 = this.element,
            n2 = this.propertyDesc;
          ((e2 = xi(n2.type, e2)),
            n2.isMany ? t2.get(n2.name).push(e2) : t2.set(n2.name, e2));
        }),
        (ar.prototype = Object.create(ir.prototype)),
        (ar.prototype.handleNode = function (e2) {
          var t2 = this,
            n2 = this.element;
          return (
            n2
              ? (t2 = this.handleChild(e2))
              : ((n2 = this.element = this.createElement(e2)),
                this.context.addElement(n2)),
            t2
          );
        }),
        (sr.prototype = Object.create(ar.prototype)),
        (sr.prototype.addReference = function (e2) {
          this.context.addReference(e2);
        }),
        (sr.prototype.handleText = function (e2) {
          if (!Qi(this.element).bodyProperty)
            throw Ji("unexpected body text <" + e2 + ">");
          ir.prototype.handleText.call(this, e2);
        }),
        (sr.prototype.handleEnd = function () {
          var e2 = this.body,
            t2 = this.element,
            n2 = Qi(t2).bodyProperty;
            ...
            f(n2, function (e3, n3) {
              ...
              i3 && i3.isReference
                ...
                : (i3
                    ? (e3 = xi(i3.type, e3))
                    : "xmlns" !== n3 &&
                      ((t2 = Ei(n3, r2.ns.prefix)),
                      s2.getPackage(t2.prefix) &&
                        o2.addWarning({
                          message: "unknown attribute <" + n3 + ">",
                          element: a2,
                          property: n3,
                          value: e3,
                        })),
        ...
        (sr.prototype.getPropertyForNode = function (e2) {
          var t2,
            ...
            a2 = Qi(r2),
            s2 = i2.name,
            l2 = a2.propertiesByName[s2];
          if (l2 && !l2.isAttr)
            return Xi(l2) && (t2 = e2.attributes[qi])
              ? ((t2 = (function (e3, t3) {
                  var n3 = Ei(e3);
                  return (function (e4, t4) {
                    var n4 = e4.name,
                      i3 = e4.localName,
                      r3 = t4.xml && t4.xml.typePrefix;
                    return r3 && 0 === i3.indexOf(r3)
                      ? e4.prefix + ":" + i3.slice(r3.length)
                      : n4;
                  })(n3, t3.getPackage(n3.prefix));
                })(t2, o2)),
                E({}, l2, { effectiveType: Qi((n2 = o2.getType(t2))).name }))
              : l2;
          ...
          if (p2) {
            if (
              ((t2 = Zi(i2, p2)),
              (n2 = o2.getType(t2)),
              (l2 = u(a2.properties, function (e3) {
                return (
                  !e3.isVirtual &&
                  !e3.isReference &&
                  !e3.isAttribute &&
            ...
            (l2 = u(a2.properties, function (e3) {
              return (
                !e3.isReference && !e3.isAttribute && "Element" === e3.type
              );
            }))
          )
            return l2;
        ...
        (sr.prototype.handler = function (e2) {
          return "Element" === e2
            ? new pr(this.model, e2, this.context)
            : new sr(this.model, e2, this.context);
        }),
        (sr.prototype.handleChild = function (e2) {
          var t2, n2, i2, r2;
          if (
            ((t2 = this.getPropertyForNode(e2)),
            (i2 = this.element),
            bi((n2 = t2.effectiveType || t2.type)))
          )
            return this.valueHandler(t2, i2);
          var o2 = (r2 = t2.isReference
            ? this.referenceHandler(t2).handleNode(e2)
            : this.handler(n2).handleNode(e2)).element;
          return (
            void 0 !== o2 &&
              (t2.isMany ? i2.get(t2.name).push(o2) : i2.set(t2.name, o2),
              t2.isReference
                ? (E(o2, { element: i2 }), this.context.addReference(o2))
                : (o2.$parent = i2)),
            r2
          );
        }),
        (lr.prototype = Object.create(sr.prototype)),
        (lr.prototype.createElement = function (e2) {
          var t2 = e2.name,
            n2 = Ei(t2),
            i2 = this.model,
            r2 = this.type,
            o2 = i2.getPackage(n2.prefix),
            a2 = (o2 && Zi(n2, o2)) || t2;
          if (!r2.hasType(a2))
            throw Ji("unexpected element <" + e2.originalName + ">");
          return sr.prototype.createElement.call(this, e2);
        }),
        (pr.prototype = Object.create(ar.prototype)),
        (pr.prototype.createElement = function (e2) {
          var t2 = e2.name,
            n2 = Ei(t2).prefix,
            i2 = e2.ns[n2 + "$uri"],
            r2 = e2.attributes;
        ...
        (pr.prototype.handleChild = function (e2) {
          var t2 = new pr(this.model, "Element", this.context).handleNode(e2),
            n2 = this.element,
            i2 = t2.element;
          return (
            void 0 !== i2 &&
              ((n2.$children = n2.$children || []).push(i2), (i2.$parent = n2)),
            t2
          );
        }),
        ...
        (cr.prototype.fromXML = function (e2, t2, n2) {
          ...
          t2 instanceof sr
            ? ((i2 = t2), (t2 = {}))
            : "string" == typeof t2
              ? ((i2 = this.handler(t2)), (t2 = {}))
              : "string" == typeof i2 && (i2 = this.handler(i2));
          var r2 = this.model,
            o2 = this.lax,
            a2 = new er(E({}, t2, { rootHandler: i2 })),
            s2 = new Hi({ proxy: true }),
            l2 = (function () {
              var e3 = [];
              return (
                Object.defineProperty(e3, "peek", {
                  value: function () {
          ...
          return (
            s2
              .ns(d2)
              .on("openTag", function (e3, t3, n3, i3) {
                var r3 = e3.attrs || {},
                  a3 = Object.keys(r3).reduce(function (e4, n4) {
                    var i4 = t3(r3[n4]);
                    return ((e4[n4] = i4), e4);
                  }, {});
                !(function (e4, t4) {
                ...
                (s2.parse(e2),
                  (function () {
                    ...
                    for (e3 = 0; (t4 = i3[e3]); e3++) {
                      var r4 = t4.element,
                        o4 = n4[t4.id],
                        s3 = Qi(r4).propertiesByName[t4.property];
                      if (
                        (o4 ||
                          a2.addWarning({
                            message: "unresolved reference <" + t4.id + ">",
                            element: t4.element,
                        ...
                        var l4 = r4.get(s3.name),
                          p4 = l4.indexOf(t4);
                        (-1 === p4 && (p4 = l4.length),
                          o4 ? (l4[p4] = o4) : l4.splice(p4, 1));
      ...
      function fr(e2) {
        ...
        ((this.byUri = function (t3) {
          ...
          (this.add = function (e3, t3) {
            ((n2[e3.uri] = e3),
              t3 ? r2.push(e3) : o2.push(e3),
              this.mapPrefix(e3.prefix, e3.uri));
          }),
      ...
      function kr(e2) {
        return (
          (e2 = E({ format: false, preamble: true }, e2 || {})),
          {
            toXML: function (t2, n2) {
              var i2 = n2 || new Rr(),
                r2 = new Sr(i2, e2.format);
              if (
                (e2.preamble &&
                  r2.append('<?xml version="1.0" encoding="UTF-8"?>\n'),
                new _r().build(t2).serializeTo(r2),
                !n2)
              )
                return i2.value;
            },
      ...
      ((wr.prototype.build = function (e2) {
        ...
        (br.prototype.serializeValue = br.prototype.serializeTo =
          function (e2) {
        ...
        dr(Er, br),
        (Er.prototype.serializeTo = function (e2) {
          (e2.appendIndent().append("<" + this.tagName + ">"),
            this.serializeValue(e2),
            e2.append("</" + this.tagName + ">").appendNewLine());
        }),
        (_r.prototype.build = function (e2) {
          ...
          var t2,
            n2,
            i2 = e2.$descriptor,
            r2 = this.propertyDescriptor,
            o2 = i2.isGeneric;
          return (
            (t2 = o2 ? this.parseGeneric(e2) : this.parseNsAttributes(e2)),
            (this.ns = r2 ? this.nsPropertyTagName(r2) : this.nsTagName(i2)),
            ...
            this.parseGenericAttributes(e2, t2),
            this
          );
        }),
        (_r.prototype.nsTagName = function (e2) {
          return (function (e3, t2) {
            return t2.isGeneric
              ? E({ localName: t2.ns.localName }, e3)
              : E({ localName: mr(t2.ns.localName, t2.$pkg) }, e3);
        ...
        (_r.prototype.nsAttributeName = function (e2) {
          var t2;
          if (((t2 = p(e2) ? Ei(e2) : e2.ns), e2.inherited))
            return { localName: t2.localName };
          var n2 = this.logNamespaceUsed(t2);
          return (
            this.getNamespaces().logUsed(n2),
            this.isLocalNs(n2)
              ? { localName: t2.localName }
              : E({ localName: t2.localName }, n2)
          );
        }),
        (_r.prototype.parseGeneric = function (e2) {
          ...
          return (
            f(e2, function (r2, o2) {
              "$body" === o2
                ? n2.push(new br().build({ type: "String" }, r2))
                : "$children" === o2
                  ? f(r2, function (e3) {
                      n2.push(new _r(t2).build(e3));
                    })
                  : 0 !== o2.indexOf("$") &&
                    t2.parseNsAttribute(e2, o2, r2) &&
                    i2.push({ name: o2, value: r2 });
            }),
            i2
          );
        }),
        (_r.prototype.parseNsAttribute = function (e2, t2, n2) {
          var i2,
            ...
            o2 = Ei(t2);
          if (
            ("xmlns" === o2.prefix && (i2 = { prefix: o2.localName, uri: n2 }),
            o2.prefix || "xmlns" !== o2.localName || (i2 = { uri: n2 }),
            !i2)
          )
        ...
        (_r.prototype.parseContainments = function (e2) {
          var t2 = this,
            ...
            i2 = this.element;
          f(e2, function (e3) {
            var r2 = i2.get(e3.name),
              o2 = e3.isReference;
            if ((e3.isMany || (r2 = [r2]), e3.isBody))
              n2.push(new br().build(e3, r2[0]));
            else if (bi(e3.type))
              f(r2, function (i3) {
                n2.push(
                  new Er(t2.addTagName(t2.nsPropertyTagName(e3))).build(e3, i3),
                );
              });
            else if (o2)
              f(r2, function (i3) {
                n2.push(
                  new wr(t2.addTagName(t2.nsPropertyTagName(e3))).build(i3),
                );
              });
            else {
              var a2 = Xi(e3),
              ...
              f(r2, function (i3) {
                var r3;
                ((r3 = a2 ? new Ar(t2, e3) : s2 ? new _r(t2, e3) : new _r(t2)),
                  n2.push(r3.build(i3)));
              });
            }
          });
        ...
        (_r.prototype.getNamespaces = function (e2) {
          ...
          return (
            n2 ||
              ((t2 = i2 && i2.getNamespaces()),
              e2 || !t2 ? (this.namespaces = n2 = new fr(t2)) : (n2 = t2)),
            n2
          );
        }),
        (_r.prototype.logNamespace = function (e2, t2, n2) {
          var i2 = this.getNamespaces(n2),
            r2 = e2.uri,
            o2 = e2.prefix;
          return (
            (i2.byUri(r2) && !n2) || i2.add(e2, t2),
            i2.mapPrefix(o2, r2),
            e2
          );
        }),
        (_r.prototype.logNamespaceUsed = function (e2, t2) {
          var n2,
            i2,
            r2,
            o2 = this.element.$model,
            a2 = this.getNamespaces(t2),
            s2 = e2.prefix,
            l2 = e2.uri;
          if (!s2 && !l2) return { localName: e2.localName };
          if (
            ((r2 = Ui[s2] || (o2 && (o2.getPackage(s2) || {}).uri)),
            !(l2 = l2 || r2 || a2.uriByPrefix(s2)))
          )
            throw new Error("no namespace uri given for prefix <" + s2 + ">");
          if (!(e2 = a2.byUri(l2))) {
        ...
        (_r.prototype.addAttribute = function (e2, t2) {
          ...
          var i2 = (function (e3, t3) {
              ...
              return (
                t3.name.localName === e2.localName &&
                t3.name.uri === e2.uri &&
                t3.name.prefix === e2.prefix
              );
            }),
            r2 = { name: e2, value: t2 };
          ...
          (n2 &&
            (t2 = (function (e3) {
              return e3
                ...
                .map(function (e4) {
                  return {
                    name: "xmlns" + (e4.prefix ? ":" + e4.prefix : ""),
                    value: e4.uri,
                  };
                });
            })(n2).concat(t2)),
        ...
        (_r.prototype.serializeTo = function (e2) {
          var t2 = this.body[0],
            n2 = t2 && t2.constructor !== br;
          (e2.appendIndent().append("<" + this.tagName),
            this.serializeAttributes(e2),
            e2.append(t2 ? ">" : " />"),
            t2 &&
              (n2 && e2.appendNewLine().indent(),
              f(this.body, function (t3) {
                t3.serializeTo(e2);
              }),
              n2 && e2.unindent().appendIndent(),
              e2.append("</" + this.tagName + ">")),
            e2.appendNewLine());
        }),
        dr(Ar, _r),
        (Ar.prototype.parseNsAttributes = function (e2) {
          var t2 = _r.prototype.parseNsAttributes.call(this, e2),
            n2 = e2.$descriptor;
          if (n2.name === this.propertyDescriptor.type) return t2;
          var i2 = (this.typeNs = this.nsTagName(n2));
          this.getNamespaces().logUsed(this.typeNs);
          var r2 = e2.$model.getPackage(i2.uri),
            o2 = (r2.xml && r2.xml.typePrefix) || "";
          return (
            this.addAttribute(
              this.nsAttributeName(qi),
              (i2.prefix ? i2.prefix + ":" : "") + o2 + n2.ns.localName,
            ),
            t2
          );
        }),
        ...
        (Cr.prototype = Object.create(Mi.prototype)),
        (Cr.prototype.fromXML = function (e2, t2, n2) {
          p(t2) || ((n2 = t2), (t2 = "bpmn:Definitions"));
          var i2 = new cr(E({ model: this, lax: true }, n2)),
            r2 = i2.handler(t2);
      ...
      var Mr = {
          ...
          types: [
            {
              ...
              properties: [
                ...
                { name: "implementationRef", isAttr: true, type: "String" },
              ],
            },
            {
              name: "Operation",
            ...
            { name: "Performer", superClass: ["ResourceRole"] },
            {
              ...
              properties: [
                ...
                { name: "isClosed", isAttr: true, type: "Boolean" },
                ...
                { name: "isExecutable", isAttr: true, type: "Boolean" },
              ],
            },
            {
              name: "LaneSet",
            ...
            },
            {
              ...
              properties: [
                ...
                { name: "name", isAttr: true, type: "String" },
                { name: "escalationCode", isAttr: true, type: "String" },
              ],
              superClass: ["RootElement"],
            },
            {
            ...
            },
            {
              ...
              properties: [
                { name: "name", isAttr: true, type: "String" },
                { name: "capacity", isAttr: true, type: "Integer" },
                {
                  name: "isUnlimited",
                  default: true,
                  isAttr: true,
            ...
            },
            {
              ...
              properties: [
                ...
                { name: "structureRef", isAttr: true, type: "String" },
                {
                  name: "isCollection",
                  default: false,
                  isAttr: true,
            ...
            },
            {
              ...
              properties: [
                { name: "isImmediate", isAttr: true, type: "Boolean" },
                {
            ...
            },
            {
              ...
              properties: [
                { name: "name", isAttr: true, type: "String" },
                { name: "isRequired", isAttr: true, type: "Boolean" },
                {
                  name: "type",
                  type: "ItemDefinition",
                  isAttr: true,
            ...
            },
            {
              name: "ParticipantMultiplicity",
              properties: [
                { name: "minimum", default: 0, isAttr: true, type: "Integer" },
                { name: "maximum", default: 1, isAttr: true, type: "Integer" },
              ],
              superClass: ["BaseElement"],
            },
            {
            ...
            { name: "Artifact", isAbstract: true, superClass: ["BaseElement"] },
            {
              name: "CategoryValue",
              superClass: ["BaseElement"],
              properties: [
            ...
            },
            {
              ...
              superClass: ["SubProcess"],
              properties: [
                { name: "protocol", isAttr: true, type: "String" },
            ...
            },
            {
              ...
              superClass: ["GlobalTask"],
              properties: [
                { name: "scriptLanguage", isAttr: true, type: "String" },
            ...
            },
            {
              name: "Import",
              properties: [
                { name: "importType", isAttr: true, type: "String" },
                { name: "location", isAttr: true, type: "String" },
                { name: "namespace", isAttr: true, type: "String" },
              ],
            },
            {
              name: "Definitions",
              ...
              properties: [
                { name: "name", isAttr: true, type: "String" },
                { name: "targetNamespace", isAttr: true, type: "String" },
                {
                ...
                { name: "diagrams", isMany: true, type: "bpmndi:BPMNDiagram" },
                { name: "exporter", isAttr: true, type: "String" },
                { name: "relationships", type: "Relationship", isMany: true },
                { name: "exporterVersion", isAttr: true, type: "String" },
              ],
            },
          ],
          enumerations: [
          ...
          types: [
            ...
            },
            {
              ...
              properties: [
                ...
                { name: "isHorizontal", isAttr: true, type: "Boolean" },
                { name: "isExpanded", isAttr: true, type: "Boolean" },
                { name: "isMarkerVisible", isAttr: true, type: "Boolean" },
                { name: "label", type: "BPMNLabel" },
                { name: "isMessageVisible", isAttr: true, type: "Boolean" },
                {
        ...
        dc: {
          ...
          types: [
            ...
            },
            {
              name: "Point",
              properties: [
                { name: "x", type: "Real", default: "0", isAttr: true },
                { name: "y", type: "Real", default: "0", isAttr: true },
              ],
            },
            {
              name: "Bounds",
        ...
        di: {
          ...
          types: [
            ...
            { name: "Node", isAbstract: true, superClass: ["DiagramElement"] },
            {
              name: "Edge",
              isAbstract: true,
            ...
            },
            {
              ...
              properties: [
                ...
                { name: "name", isAttr: true, type: "String" },
                { name: "documentation", isAttr: true, type: "String" },
                { name: "resolution", isAttr: true, type: "Real" },
                {
                  name: "ownedStyle",
                  type: "Style",
                  isReadOnly: true,
            ...
            {
              name: "Extension",
              properties: [{ name: "values", isMany: true, type: "Element" }],
            },
          ],
          associations: [],
          ...
          types: [
            {
              ...
              properties: [
                { name: "stroke", isAttr: true, type: "String" },
                { name: "fill", isAttr: true, type: "String" },
              ],
            },
            {
              name: "ColoredEdge",
          ...
          types: [
            {
              ...
              properties: [{ name: "color", isAttr: true, type: "String" }],
            },
            {
              name: "ColoredShape",
              extends: ["bpmndi:BPMNShape"],
      ...
      function Nr(e2) {
        ...
        function a2(t3, n3) {
          try {
            ...
            (s2(e3.message, { element: t3, error: e3 }),
              console.error(`failed to import ${Et(t3)}`, e3));
          }
        }
        function s2(t3, n3) {
          e2.error(t3, n3);
        ...
        var l2 = (this.registerDi = function (e3) {
          ...
          n3
            ? i2[n3.id]
              ? s2(`multiple DI elements defined for ${Et(n3)}`, {
                  element: n3,
                })
              : ((i2[n3.id] = e3),
                c((t3 = n3), "di") ||
                  Object.defineProperty(t3, "di", {
                    enumerable: false,
                    get: function () {
                      throw new Error(Or);
                    },
        ...
        this.handleDefinitions = function (o3, a3) {
          var c2 = o3.diagrams;
          if (a3 && -1 === c2.indexOf(a3))
            throw new Error("diagram not part of <bpmn:Definitions />");
          if ((!a3 && c2 && c2.length && (a3 = c2[0]), !a3))
          ...
          if (!v3) {
            ...
            (s2(`correcting missing bpmnElement on ${Et(m3)} to ${Et(v3)}`),
              (m3.bpmnElement = v3),
              l2(m3));
          }
          var x3,
          ...
          if (Tr(v3, "bpmn:Process") || Tr(v3, "bpmn:SubProcess")) y2(v3, b3);
            ...
            if (!Tr(v3, "bpmn:Collaboration"))
              throw new Error(
                `unsupported bpmnElement for ${Et(m3)}: ${Et(v3)}`,
              );
            ((w3 = b3),
              f((x3 = v3).participants, r2(P2, w3)),
              E2(x3.artifacts, w3),
              n2.push(function () {
                !(function (e3, t3) {
                  f(e3, r2(g2, t3));
        ...
        function R2(e3, t3) {
          var i3 = a2(e3, t3);
          (Tr(e3, "bpmn:SubProcess") && A2(e3, i3 || t3),
            Tr(e3, "bpmn:Activity") && _2(e3.ioSpecification, t3),
            n2.push(function () {
              (f(e3.dataInputAssociations, r2(v2, t3)),
                f(e3.dataOutputAssociations, r2(v2, t3)));
            }));
        }
        function S2(e3, t3) {
          a2(e3, t3);
        ...
        function k2(e3, t3) {
          n2.push(function () {
            var n3 = a2(e3, t3);
            (e3.childLaneSet && C2(e3.childLaneSet, n3 || t3),
              (function (e4) {
        ...
        function M2(e3, t3) {
          (!(function (e4, t4) {
            f(e4, function (e5) {
              Tr(e5, "bpmn:SequenceFlow")
                ? n2.push(function () {
                    !(function (e6, t5) {
                      a2(e6, t5);
                    })(e5, t4);
                  })
                : Tr(e5, "bpmn:BoundaryEvent")
                  ? n2.unshift(function () {
                      R2(e5, t4);
                    })
                  : Tr(e5, "bpmn:FlowNode")
                    ? R2(e5, t4)
                    : Tr(e5, "bpmn:DataObject") ||
                      (Tr(e5, "bpmn:DataStoreReference") ||
                      Tr(e5, "bpmn:DataObjectReference")
                        ? S2(e5, t4)
                        : s2(
                            `unrecognized flowElement ${Et(e5)} in context ${Et(t4 && t4.businessObject)}`,
                            { element: e5, context: t4 },
                          ));
            });
          })(e3.flowElements, t3),
            e3.laneSets &&
      ...
      function Dr(e2, t2, n2) {
        ...
        function s2(e3, t3) {
          ...
          var r3 = (function (e4, t4) {
            ...
            var n4,
              i3 = t4.plane.bpmnElement,
              r4 = i3;
            R(i3, "bpmn:Process") ||
              R(i3, "bpmn:Collaboration") ||
              (r4 = (function (e5) {
                var t5 = e5;
                for (; t5; ) {
            ...
            n4 = R(r4, "bpmn:Collaboration")
              ? r4
              : u(e4.rootElements, function (e5) {
                  if (R(e5, "bpmn:Collaboration"))
                    return u(e5.participants, function (e6) {
            ...
            var a3 = Br(o3),
              ...
              l2 = [i3];
            return (
              f(e4.diagrams, function (e5) {
                if (e5.plane) {
                  var t5 = e5.plane.bpmnElement;
                  -1 !== a3.indexOf(t5) &&
                    -1 === l2.indexOf(t5) &&
                    (s4.push(e5), l2.push(t5));
                }
              }),
              s4
            );
        ...
        return new Promise(function (l2, p2) {
          try {
            return (
              (i2 = e2.get("bpmnImporter")),
              (r2 = e2.get("eventBus")),
              (o2 = e2.get("canvas")),
              r2.fire("import.render.start", { definitions: t2 }),
              s2(t2, n2),
              r2.fire("import.render.complete", {
                error: void 0,
                warnings: a2,
              }),
              l2({ warnings: a2 })
      ...
      var Lr,
        ...
        zr =
          '<div class="bjs-powered-by-lightbox"><div class="backdrop"></div><div class="notice"><a href="https://bpmn.io" target="_blank" rel="noopener" class="link">' +
          Ir +
          '</a><span>Web-based tooling for BPMN, DMN and forms powered by <a href="https://bpmn.io" target="_blank" rel="noopener">bpmn.io</a>.</span></div></div>';
      function Gr() {
        (Lr ||
          (Oe((Lr = qe(zr)), Vr),
          Oe(Ye("svg", Lr), jr),
          Oe(Ye(".backdrop", Lr), Wr),
          Oe(Ye(".notice", Lr), $r),
          Oe(Ye(".link", Lr), Fr, {
            margin: "15px 20px 15px 10px",
            alignSelf: "center",
          }),
          Ge.bind(Lr, ".backdrop", "click", function (e2) {
      ...
      function Hr(e2) {
        ((e2 = E({}, Ur, e2)),
          (this._moddle = this._createModdle(e2)),
          (this._container = this._createContainer(e2)) /**
          ...
          (function (e3) {
            const t2 = qe(
              '<a href="http://bpmn.io" target="_blank" class="bjs-powered-by" title="Powered by bpmn.io" >' +
                Ir +
                "</a>",
            );
            (Oe(Ye("svg", t2), jr),
              ...
              e3.appendChild(t2),
              We.bind(t2, "click", function (e4) {
                (Gr(), e4.preventDefault());
              }));
          })(this._container),
          this._init(this._container, this._moddle, e2));
      }
      function Kr(e2, t2) {
        return ((e2.warnings = t2), e2);
      }
      (e(Hr, mi),
        (Hr.prototype.importXML = async function (e2, t2) {
          const n2 = this;
          let i2 = [];
          try {
            let o2;
            ...
            ((i2 = i2.concat(l2)),
              (a2 =
                this._emit(
                  ...
                  n2.get("eventBus").createEvent(r2)),
                ) || a2));
            const c2 = await this.importDefinitions(a2, t2);
            return (
              (i2 = i2.concat(c2.warnings)),
              this._emit("import.done", { error: null, warnings: i2 }),
              { warnings: i2 }
            );
          } catch (e3) {
            let t3 = e3;
            throw (
              (i2 = i2.concat(t3.warnings || [])),
              Kr(t3, i2),
              (t3 = (function (e4) {
                const t4 =
              ...
              this._emit("import.done", { error: t3, warnings: t3.warnings }),
              t3
            );
          }
          var r2;
        ...
        (Hr.prototype.saveXML = async function (e2) {
          ...
          let t2,
            n2,
            i2 = this._definitions;
          try {
            if (!i2) throw new Error("no definitions loaded");
            i2 = this._emit("saveXML.start", { definitions: i2 }) || i2;
            ((n2 = (await this._moddle.toXML(i2, e2)).xml),
              (n2 = this._emit("saveXML.serialized", { xml: n2 }) || n2));
          } catch (e3) {
            t2 = e3;
          }
        ...
        (Hr.prototype.saveSVG = async function () {
          ...
          try {
            const t3 = this.get("canvas"),
              n2 = t3.getActiveLayer(),
              i2 = Ye(":scope > defs", t3._svg),
              r2 = re(n2),
              o2 = i2 ? "<defs>" + re(i2) + "</defs>" : "",
              a2 = n2.getBBox();
            e2 =
          ...
          if ((this._emit("saveSVG.done", { error: t2, svg: e2 }), t2))
            throw t2;
          return { svg: e2 };
        }),
        ...
        (Hr.prototype.attachTo = function (e2) {
          ...
          (this.detach(),
            e2.get && e2.constructor.prototype.jquery && (e2 = e2.get(0)),
            "string" == typeof e2 && (e2 = Ye(e2)),
        ...
        (Hr.prototype._init = function (e2, t2, n2) {
          const i2 = n2.modules || this.getModules(n2),
            r2 = n2.additionalModules || [],
            o2 = [].concat(
              [{ bpmnjs: ["value", this], moddle: ["value", t2] }],
              i2,
              r2,
            ),
            a2 = E(
              (function (e3, t3) {
                let n3 = {};
                return (
                  f(Object(e3), function (e4, i3) {
                    -1 === t3.indexOf(i3) && (n3[i3] = e4);
                  }),
                  n3
                );
              })(n2, ["additionalModules"]),
              { canvas: E({}, n2.canvas, { container: e2 }), modules: o2 },
            );
          (mi.call(this, a2),
            n2 && n2.container && this.attachTo(n2.container));
        }),
      ...
      return (
        e(Yr, Hr),
        (Yr.prototype._modules = [kt, nn, un, It, Rn, gt]),
        (Yr.prototype._moddleExtensions = {}),
        Yr
      );
    });
  },
...
var xmlDecodeTree = /* @__PURE__ */ decodeBase64(
...
(function (EntityDecoderState3) {
  ...
  EntityDecoderState3[(EntityDecoderState3["NumericStart"] = 1)] =
    "NumericStart";
  EntityDecoderState3[(EntityDecoderState3["NumericDecimal"] = 2)] =
    "NumericDecimal";
...
var EntityDecoder = class {
  ...
  emitNotTerminatedNamedEntity() {
    ...
    (_a3 = this.errors) === null || _a3 === void 0
      ? void 0
      : _a3.missingSemicolonAfterCharacterReference();
    return this.consumed;
  }
  /**
   * Emit a named entity.
...
var Parser = class {
   ...
   */
    ...
    if (this.ended) {
      (_b = (_a3 = this.cbs).onerror) === null || _b === void 0
        ? void 0
        : _b.call(_a3, new Error(".end() after done!"));
      return;
    }
  ...
  get attributes() {
    return Object.keys(this.attribs).map((name) => {
      ...
      return {
        ...
        namespace:
          (_a3 = this["x-attribsNamespace"]) === null || _a3 === void 0
            ? void 0
            : _a3[name],
        prefix:
...
function replaceCodePoint2(codePoint) {
  ...
  return (_a3 = decodeMap2.get(codePoint)) !== null && _a3 !== void 0
    ? _a3
    : codePoint;
}
...
function formatAttributes(attributes2, opts) {
  ...
  return Object.keys(attributes2)
    .map((key2) => {
      var _a4, _b;
      const value =
        (_a4 = attributes2[key2]) !== null && _a4 !== void 0 ? _a4 : "";
      if (opts.xmlMode === "foreign") {
        key2 =
          (_b = attributeNames.get(key2)) !== null && _b !== void 0 ? _b : key2;
      }
...
function renderTag(elem, opts) {
  ...
  if (opts.xmlMode === "foreign") {
    elem.name =
      (_a3 = elementNames.get(elem.name)) !== null && _a3 !== void 0
        ? _a3
        : elem.name;
...
function getAtomFeed(feedRoot) {
  ...
  const href =
    (_a3 = getOneElement("link", childs)) === null || _a3 === void 0
      ? void 0
      : _a3.attribs["href"];
  if (href) {
    feed.link = href;
...
function createDocumentStream(callback, options, elementCallback) {
  const handler4 = new DomHandler(
    (error) => callback(error, handler4.root),
    options,
    elementCallback,
  );
  ...
  upgrade(element) {
    ...
    if (registry.has(ce)) {
      ...
      if (check(element)) {
        ...
        for (const attr of attributes2) element.removeAttributeNode(attr);
        const values = entries(element);
        for (const [key2] of values) delete element[key2];
        setPrototypeOf(element, Class.prototype);
        ownerDocument[UPGRADE] = { element, values };
        new Class(ownerDocument, ce);
        customElements.set(element, { connected: isConnected2 });
        for (const attr of attributes2) element.setAttributeNode(attr);
      ...
      onopentag(name, attributes2) {
        ...
        if (isHTML) {
          if (ownerSVGElement) {
            node = append2(
              node,
              document2.createElementNS(SVG_NAMESPACE, name),
              active,
            );
        ...
        if (create3) node = append2(node, document2.createElement(name), false);
        let end = node[END];
        for (const name2 of keys(attributes2))
          attribute(
            node,
            end,
            document2.createAttribute(name2),
            attributes2[name2],
            active,
          );
      },
    ...
    for (const observer of observers) {
      for (const [
        ...
        if (childList) {
          if (
            (parentNode &&
              (target === parentNode /* c8 ignore next */ ||
                (subtree && target.contains(parentNode)))) ||
            (!parentNode &&
              ((subtree &&
                (target === ownerDocument /* c8 ignore next */ ||
...
var attributeRules = {
  ...
  start(next, data, options) {
    ...
    return (elem) => {
      var _a3;
      return (
        !!((_a3 = adapter2.getAttributeValue(elem, name)) === null ||
        _a3 === void 0
          ? void 0
...
var pseudos = {
  ...
  "last-child"(elem, { adapter: adapter2, equals }) {
    ...
    for (let i = siblings.length - 1; i >= 0; i--) {
      ...
      if (adapter2.isTag(siblings[i])) break;
    }
    return false;
  },
...
function compilePseudoSelector(
  ...
  const userPseudo =
    (_a3 = options.pseudos) === null || _a3 === void 0 ? void 0 : _a3[name];
  const stringPseudo =
  ...
  switch (selector.type) {
    ...
    case import_css_what3.SelectorType.Parent: {
      return function parent(elem) {
        return adapter2
          .getChildren(elem)
          .some((elem2) => adapter2.isTag(elem2) && next(elem2));
      };
    }
...
function compileUnsafe(selector, options, context) {
  const token =
    typeof selector === "string"
      ? (0, import_css_what4.parse)(selector)
      : selector;
  return compileToken(token, options, context);
}
function includesScopePseudo(t) {
  return (
    t.type === import_css_what4.SelectorType.Pseudo &&
    (t.name === "scope" ||
...
function absolutize(token, { adapter: adapter2 }, context) {
  ...
  for (const t of token) {
    if (
      t.length > 0 &&
      isTraversal(t[0]) &&
      t[0].type !== import_css_what4.SelectorType.Descendant
    ) {
  ...
  const query2 = token
    .map((rules) => {
      if (rules.length >= 2) {
        ...
        if (
          first.type !== import_css_what4.SelectorType.Pseudo ||
          first.name !== "scope"
        ) {
        } else if (
          isArrayContext &&
...
var existsOne2 = (test, elements) =>
  elements.some(
    (element) =>
      isTag3(element) &&
      (test(element) || existsOne2(test, getChildren2(element))),
  );
var getAttributeValue2 = (element, name) =>
...
var getText2 = (node) => {
  if (isArray(node)) return node.map(getText2).join("");
  if (isTag3(node)) return getText2(getChildren2(node));
...
var findAll2 = (test, nodes) => {
  ...
  for (const node of nodes) {
    if (isTag3(node)) {
      if (test(node)) matches2.push(node);
...
var findOne2 = (test, nodes) => {
  for (let node of nodes)
    if (test(node) || (node = findOne2(test, getChildren2(node)))) return node;
  return null;
};
var adapter = {
  isTag: isTag3,
...
var ParentNode = class extends Node2 {
  ...
  getElementsByTagName(tagName19) {
    ...
    while (next !== end) {
      if (
        next.nodeType === ELEMENT_NODE &&
        (next.localName === tagName19 || localCase(next) === tagName19)
      )
        elements.push(next);
      next = next[NEXT];
    }
  ...
  querySelectorAll(selectors) {
    ...
    let { [NEXT]: next, [END]: end } = this;
    while (next !== end) {
      if (next.nodeType === ELEMENT_NODE && matches2(next)) elements.push(next);
      next =
        next.nodeType === ELEMENT_NODE && next.localName === "template"
          ? next[END]
          : next[NEXT];
...
var Document2 = class extends NonElementParentNode {
  ...
  cloneNode(deep = false) {
    ...
    if (deep) {
      ...
      if (doctype) document2[DOCTYPE] = childNodes[0];
    }
    return document2;
  }
...
var DOMParser2 = class _DOMParser {
  ...
  parseFromString(markupLanguage, mimeType, globals = null) {
    ...
    } else if (mimeType === "image/svg+xml") document2 = new SVGDocument();
    else document2 = new XMLDocument();
    document2[DOM_PARSER] = _DOMParser;
    if (globals) document2[GLOBALS] = globals;
...
var parseHTML = (html, globals = null) =>
  new DOMParser2().parseFromString(html, "text/html", globals).defaultView;
function Document4() {
  illegalConstructor();
}
...
// src/render.mjs
var import_bpmn_viewer_production_min = __toESM(
  require_bpmn_viewer_production_min(),
  1,
);
